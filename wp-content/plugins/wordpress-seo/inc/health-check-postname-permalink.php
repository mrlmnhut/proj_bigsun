...
class WPSEO_Health_Check_Postname_Permalink extends WPSEO_Health_Check{
	...
	public function run(){
		if ($this->has_postname_in_permalink()){
			$this->label          = esc_html__('Your permalink structure includes the post name',
				'wordpress-seo');
			$this->status         = self::STATUS_GOOD;
			$this->badge['color'] = 'blue';
			$this->description    = esc_html__('You do have your postname in the URL of your posts and pages.',
				'wordpress-seo');

			return;
		}

		$this->label          = esc_html__('You do not have your postname in the URL of your posts and pages',
			'wordpress-seo');
		...
		/* translators: %s expands to '/%postname%/' */
			__('It\'s highly recommended to have your postname in the URL of your posts and pages. Consider setting your permalink structure to %s.',
				'wordpress-seo'),
