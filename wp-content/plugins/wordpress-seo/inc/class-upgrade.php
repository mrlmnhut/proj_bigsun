...
class WPSEO_Upgrade {
	...
	private function upgrade_128(){
		...
		Yoast_Notification_Center::get()
		                         ->remove_notification_by_id('wpseo-dismiss-page_comments-notice');
		Yoast_Notification_Center::get()
		                         ->remove_notification_by_id('wpseo-dismiss-wordpress-upgrade');
	}
	...
	private function upgrade_132(){
		...
		Yoast_Notification_Center::get()
		                         ->remove_notification_by_id('wpseo-dismiss-permalink-notice');
