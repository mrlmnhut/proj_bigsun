				...
				<div class="wp-clearfix">
					<p>
						<a href="<?php WPSEO_Shortlinker::show( 'https://yoa.st/jq' ); ?>" target="_blank">
                            <img src="<?php echo esc_url($wpseo_plugin_dir_url . 'images/local_plugin_assistant.svg'); ?>" alt="">
				...
				<div class="wp-clearfix">
					<p>
						<a href="<?php WPSEO_Shortlinker::show( 'https://yoa.st/jo' ); ?>" target="_blank">
                            <img src="<?php echo esc_url($wpseo_plugin_dir_url . 'images/video_plugin_assistant.svg'); ?>" class="alignleft" alt="">
				...
				<div class="wp-clearfix">
					<p>
						<a href="<?php WPSEO_Shortlinker::show( 'https://yoa.st/jp' ); ?>" target="_blank">
                            <img src="<?php echo esc_url($wpseo_plugin_dir_url . 'images/woo_plugin_assistant.svg'); ?>" alt="">
				...
				<div class="wp-clearfix">
					<p>
						<a href="<?php WPSEO_Shortlinker::show( 'https://yoa.st/jr' ); ?>" target="_blank">
                            <img src="<?php echo esc_url($wpseo_plugin_dir_url . 'images/news_plugin_assistant.svg'); ?>" class="alignleft" alt="">
