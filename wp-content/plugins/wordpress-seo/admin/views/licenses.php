	...
	<div id="extensions">
		<section class="yoast-seo-premium-extension">
			...
			<?php else : ?>
                ...
                <a target="_blank" href="<?php echo esc_url($premium_extension->get_buy_url()); ?>" class="yoast-button-upsell">
					<?php
					printf(
                ...
                <a target="_blank" href="<?php echo esc_url($premium_extension->get_info_url()); ?>" class="yoast-link--more-info">
					<?php
					printf(
