...
class WPSEO_Admin_Init {
	...
	private function on_wpseo_admin_page() {
		return $this->pagenow === 'admin.php' && strpos(filter_input(INPUT_GET, 'page'),
				'wpseo') === 0;
	}
	...
	/**
	 * Shows a notice to the user if they have Google Analytics for WordPress 5.4.3 installed
	 * because it causes an error on the google search console page.
	 *
	 * @deprecated 12.5
	 *
	 * @codeCoverageIgnore
