...
class WPSEO_Metabox extends WPSEO_Meta {
	...
	public static function translate_meta_boxes() {
		...
		WPSEO_Meta::$meta_fields['advanced']['meta-robots-adv']['title']                   = __('Meta robots advanced',
			'wordpress-seo');
		WPSEO_Meta::$meta_fields['advanced']['meta-robots-adv']['description']             = __('If you want to apply advanced <code>meta</code> robots settings for this page, please define them in the following field.',
			'wordpress-seo');
