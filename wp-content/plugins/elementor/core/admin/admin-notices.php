...
class Admin_Notices extends Module{
	...
	private function notice_api_upgrade_plugin(){
		...
		if (!in_array($this->current_screen_id,
			['toplevel_page_elementor', 'edit-elementor_library', 'elementor_page_elementor-system-info', 'dashboard'],
			TRUE)){
			return FALSE;
		}
		...
		if ($has_remote_update_package){
			...
			$upgrade_url = wp_nonce_url(self_admin_url('update.php?action=upgrade-plugin&plugin=' . ELEMENTOR_PLUGIN_BASE),
				'upgrade-plugin_' . ELEMENTOR_PLUGIN_BASE);
                ...
                <div class="elementor-message-content">
                    ...
                    <p>
						...
						/* translators: 1: Details URL, 2: Accessibility text, 3: Version number, 4: Update URL, 5: Accessibility text */
							__('There is a new version of Elementor Page Builder available. <a href="%1$s" class="thickbox open-plugin-details-modal" aria-label="%2$s">View version %3$s details</a> or <a href="%4$s" class="update-link" aria-label="%5$s">update now</a>.',
								'elementor'),
							esc_url($details_url),
							esc_attr(sprintf(
	...
	private function notice_tracker(){
		...
		$tracker_description_text = __('Love using Elementor? Become a super contributor by opting in to our non-sensitive plugin data collection and to our updates. We guarantee no sensitive data is collected.',
			'elementor');
		 ...
		 *
		 */
		$tracker_description_text = apply_filters('elementor/tracker/admin_description_text',
			$tracker_description_text );
		?>
        <div class="notice updated elementor-message">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php echo esc_html($tracker_description_text); ?>
                        <a href="https://go.elementor.com/usage-data-tracking/" target="_blank"><?php echo __('Learn more.',
								'elementor'); ?></a></p>
                    <p class="elementor-message-actions">
                        <a href="<?php echo $optin_url; ?>" class="button button-primary"><?php echo __('Sure! I\'d love to help',
								'elementor'); ?></a>&nbsp;<a href="<?php echo $optout_url; ?>" class="button-secondary"><?php echo __('No thanks',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
	...
	private function notice_rate_us_feedback() {
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr($notice_id); ?>">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><strong><?php echo __('Congrats!',
								'elementor'); ?></strong> <?php _e('You created over 10 pages with Elementor. Great job! If you can spare a minute, please help us by leaving a five star review on WordPress.org.',
							'elementor'); ?></p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/admin-review/" target="_blank" class="button button-primary"><?php _e('Happy To Help',
								'elementor'); ?></a>
                        <a href="<?php echo esc_url_raw($dismiss_url); ?>" class="button elementor-button-notice-dismiss"><?php _e('Hide Notification',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
	...
	private function notice_woocommerce_promote() {
		...
		if (!in_array($this->current_screen_id, ['edit-product', 'woocommerce_page_wc-settings'],
				TRUE) || User::is_user_notice_viewed($notice_id)){
			return false;
		}
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr($notice_id); ?>">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php _e('Using WooCommerce? With Elementor Pro’s WooCommerce Builder, you’ll be able to design your store without coding!',
							'elementor'); ?></p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-woocommerce/" target="_blank" class="button button-secondary"><?php _e('Learn More',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
	...
	private function notice_cf7_promote() {
		...
		if (!in_array($this->current_screen_id,
				['toplevel_page_wpcf7', 'contact_page_wpcf7-integration'],
				TRUE) || User::is_user_notice_viewed($notice_id)){
			return false;
		}
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr($notice_id); ?>">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php _e('Using Elementor & Contact Form 7? Try out Elementor Pro and design your forms visually with one powerful tool.',
							'elementor'); ?></p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-contactform7/" target="_blank" class="button button-secondary"><?php _e('Learn More',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
	...
	private function notice_mc4wp_promote() {
		...
		if (!in_array($this->current_screen_id,
				['toplevel_page_mailchimp-for-wp', 'mc4wp_page_mailchimp-for-wp-forms', 'mc4wp_page_mailchimp-for-wp-integrations', 'mc4wp_page_mailchimp-for-wp-other', 'mc4wp_page_mailchimp-for-wp-extensions'],
				TRUE) || User::is_user_notice_viewed($notice_id)){
			return false;
		}
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr($notice_id); ?>">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php _e('Want to design better MailChimp forms? Use Elementor Pro and enjoy unlimited integrations, visual design, templates and more.',
							'elementor'); ?></p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-mc4wp/" target="_blank" class="button button-secondary"><?php _e('Learn More',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
	...
	private function notice_popup_maker_promote() {
		...
		if (!in_array($this->current_screen_id, ['edit-popup', 'popup_page_pum-settings'],
				TRUE) || User::is_user_notice_viewed($notice_id)){
			return false;
		}
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr($notice_id); ?>">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php _e('Using popups on your site? Build outstanding popups using Elementor Pro and get more leads, sales and subscribers.',
							'elementor'); ?></p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-popupmaker/" target="_blank" class="button button-secondary"><?php _e('Learn More',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
	...
	private function notice_role_manager_promote() {
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed" data-notice_id="<?php echo esc_attr($notice_id); ?>">
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php _e('Managing a multi-user site? With Elementor Pro, you can control user access and make sure no one messes up your design.',
							'elementor'); ?></p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/promotion-role-manager/" target="_blank" class="button button-secondary"><?php _e('Learn More',
								'elementor'); ?></a>
                    </p>
                </div>
            </div>
