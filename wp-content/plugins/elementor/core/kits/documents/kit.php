...
class Kit extends PageBase{
	...
	protected function _register_controls(){
		...
		Plugin::$instance->controls_manager->add_custom_css_controls($this,
			Controls_Manager::TAB_STYLE, [__('Available in Pro v2.9.', 'elementor')]);
	}
		...
		if (!$this->custom_colors_disabled || !$this->typography_schemes_disabled){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('In order for Theme Style to affect all relevant Elementor elements, please disable Default Colors and Fonts from the <a href="%s" target="_blank">Settings Page</a>.',
						'elementor'), Settings::get_url()),
