...
class Manager{
	...
	public function get_kit_for_frontend(){
		...
		if ($is_kit_preview){
			$kit = Plugin::$instance->documents->get_doc_or_auto_save($active_kit->get_main_id(),
				get_current_user_id());
	...
	public function __construct(){
		...
		add_action('elementor/frontend/after_enqueue_global',
			[$this, 'frontend_before_enqueue_styles'], 0);
