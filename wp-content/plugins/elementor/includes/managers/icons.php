	...
	public function register_admin_tools_settings( Tools $settings ) {
		...
		$settings->add_section( 'fontawesome4_migration', 'fontawesome4_migration', [
			'callback' => function() {
				...
				echo '<p>' .
				     __('Access 1,500+ amazing Font Awesome 5 icons and enjoy faster performance and design flexibility.',
					     'elementor') . '<br>' .
				     __('By upgrading, whenever you edit a page containing a Font Awesome 4 icon, Elementor will convert it to the new Font Awesome 5 icon.',
					     'elementor') .
				'</p><p><strong>' .
				     __('Please note that the upgrade process may cause some of the previously used Font Awesome 4 icons to look a bit different due to minor design changes made by Font Awesome.',
					     'elementor') .
				     '</strong></p><p>' .
				     __('The upgrade process includes a database update', 'elementor') . ' - ' .
				     __('We highly recommend backing up your database before performing this upgrade.',
					     'elementor') .
				     '</p>' .
				     __('This action is not reversible and cannot be undone by rolling back to previous versions.',
					     'elementor') .
				'</p>';
			},
			'fields' => [
