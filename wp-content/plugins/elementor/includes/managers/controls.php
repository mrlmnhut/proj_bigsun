...
class Controls_Manager {
	 ...
	 *
	 */
	public function add_custom_css_controls(
		Controls_Stack $controls_stack,
		...
		$messages = [
			__('Custom CSS lets you add CSS code to any widget, and see it render live right in the editor.',
				'elementor'),
		];
		...
		$controls_stack->add_control(
			...
			[
				...
				'raw'  => $this->get_teaser_template([
					...
					'messages' => [
						__('Attributes lets you add custom HTML attributes to any element.',
							'elementor'),
					],
