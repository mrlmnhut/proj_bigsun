...
class Server extends Base{
	...
	public function get_php_version(){
		...
		if (version_compare($result['value'], '5.4', '<')){
			$result['recommendation'] = _x('We recommend to use php 5.4 or higher', 'System Info',
				'elementor');
	...
	public function get_mysql_version(){
		...
		$db_server_version = $wpdb->get_results("SHOW VARIABLES WHERE `Variable_name` IN ( 'version_comment', 'innodb_version' )",
			OBJECT_K);
