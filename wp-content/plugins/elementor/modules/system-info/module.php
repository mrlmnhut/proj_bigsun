...
class Module extends BaseModule{
	...
	public function display_page(){
        ...
        <div id="elementor-system-info">
            ...
            <div id="elementor-system-info-raw">
                <label id="elementor-system-info-raw-code-label" for="elementor-system-info-raw-code"><?php echo __('You can copy the below info as simple text with Ctrl+C / Ctrl+V:',
						'elementor'); ?></label>
            ...
            <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
                ...
                <input type="submit" class="button button-primary" value="<?php echo __('Download System Info',
					'elementor'); ?>">
            </form>
        </div>
		<?php
	...
	public function create_reporter(array $properties){
		$properties = Model_Helper::prepare_properties($this->get_settings('reporter_properties'),
			$properties);
