...
function (_elementorModules$Mod) {
  (0, _inherits2.default)(Commands, _elementorModules$Mod);
    ...
    (0, _createClass2.default)(Commands, [{
         ...
         *
         * Checks if parameter command is the first command in trace that
         * currently running.
         *
         * @param {string} command
         *
        ...
        var Hooks =
            ...
            function () {
                ...
                (0, _createClass2.default)(Hooks, [{
                     ...
                     *
                     * Register data hook that's run before the command as
                     * dependency.
                     *
                     * @param {HookBase} instance
                     *
                     ...
                     *
                     * Run data hook that's run before the command as
                     * dependency.
                     *
                     * @param {string} command
                     * @param {{}} args
