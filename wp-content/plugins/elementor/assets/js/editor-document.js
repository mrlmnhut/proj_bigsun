...
function (_elementorModules$Mod) {
    ...
    value: function activateTab(tab) {
      ...
      jQuery(this.getTabsWrapperSelector() + ' .elementor-component-tab').off('click').on('click', function (event) {
        ...
        /**
         * If command includes uppercase character convert it to lowercase and
         * add `-`. e.g: `CopyAll` is converted to `copy-all`.
         */
        ...
        var ArgsObject =
            ...
            function () {
                ...
                (0, _createClass2.default)(ArgsObject, [{
                     ...
                     *
                     * Validate property in args using `type ===
                     * typeof(args.whatever)`.
                     *
                     * @param {string} property
                     * @param {string} type
                     * @param {{}} args
                     ...
                     *
                     * Validate property in args using `args.whatever
                     * instanceof instance`.
                     *
                     * @param {string} property
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var HookBase =
            ...
            function () {
                 ...
                 * Function initialize().
                 *
                 * Called after creation of the base, used for initialize
                 * extras. Without expending constructor.
                 */
                ...
                (0, _createClass2.default)(HookBase, [{
                     ...
                     *
                     * Condition for running the callback, if true, call to
                     * apply().
                     *
                     * @param [args={}]
                     *
  ...
  (0, _createClass2.default)(Settings, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
         ...
         * settings: { '{ container-id }': { someSettingKey: someSettingValue }
         * } etc.
         */
  ...
  (0, _createClass2.default)(Create, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        /**
         * Acknowledge history of each created item, because we cannot pass the
         * elements when they do not exist in getHistory().
         */
    ...
    value: function createSectionColumns(containers, columns, options) {
      ...
      container) {
        for (var loopIndex = 0; loopIndex < columns; loopIndex++) {
          ...
          /**
           * TODO: Try improve performance of using 'document/elements/create`
           * instead of manual create.
           */
...
/*#__PURE__*/
  ...
  (0, _createClass2.default)(ResizeColumn, [{
    ...
    value: function resizeColumn(container, newSize) {
      ...
      /**
       * TODO: Hook prevented ( next command will not call recursive hook ),
       * but we didnt tell the hook to be prevented consider:
       * '$e.hooks.preventRecursive()'.
       */
...
function (_Base) {
  ...
  (0, _createClass2.default)(AddTransaction, [{
      ...
      value: function initialize(args) {
          ...
          /**
           * Debounce always send 'add-transaction' with title & subTitle, when
           * the transaction already started, there is no need to save those
           * args they are useless.
           */
...
function (_Base) {
  ...
  (0, _createClass2.default)(LogSubItem, [{
    ...
    value: function apply(args) {
      ...
      /**
       * Sometimes `args.id` passed to `LogSubItem`, to add sub item for
       * specific id. this `id` should not be passed as sub-item.
       */
...
/**
 * The difference between 'document/elements/settings` and
 * `document/dynamic/settings` is: that `document/elements/settings` apply
 * settings to `container.settings` and `document/dynamic/settings` affect
 * `container.settings.__dynamic__`, also clearing the dynamic if
 * `args.settings` is empty.
 */
var Settings =
/*#__PURE__*/
function (_Debounce) {
