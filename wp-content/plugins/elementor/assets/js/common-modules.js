...
// 7.1.15 ToLength
        ...
        var min = Math.min;
        module.exports = function (it) {
            return it > 0 ? min(toInteger(it), 0x1fffffffffffff) : 0; // pow(2,
                                                                      // 53) -
                                                                      // 1 ==
                                                                      // 9007199254740991
        };
    ...
    value: function activateTab(tab) {
      ...
      jQuery(this.getTabsWrapperSelector() + ' .elementor-component-tab').off('click').on('click', function (event) {
        ...
        value: function importCommands(commandsFromImport) {
            ...
            var commands = {}; // Convert `Commands` to `ComponentBase`
                               // workable format.
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        var BUGGY = !([].keys && 'next' in [].keys()); // Safari has buggy
                                                       // iterators w/o `next`
...
if (!USE_NATIVE) {
    ...
    wksExt.f = function (name) {
        ...
        for (var es6Symbols = (
            // 19.4.2.2, 19.4.2.3, 19.4.2.4, 19.4.2.6, 19.4.2.8, 19.4.2.9,
            // 19.4.2.10, 19.4.2.11, 19.4.2.12, 19.4.2.13, 19.4.2.14
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var Module = function Module() {
            ...
            this.off = function (eventName, callback) {
                ...
                if (-1 !== callbackIndex) {
                    delete events[eventName][callbackIndex]; // Reset array
                                                             // index (for next
                                                             // off on same
                                                             // event).
...
// TODO: Wrong location used as `elementorModules.ForceMethodImplementation();
// should be` `elementorUtils.ForceMethodImplementation()`;
