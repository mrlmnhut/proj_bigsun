        ...
        if (!(attrs[field.name] instanceof Backbone.Collection)) {
          attrs[field.name] = new Backbone.Collection(attrs[field.name], {
            model: function model(attributes, options) {
              options = options || {};
                options.controls = {}; // eslint-disable-next-line
                                       // no-unused-vars
...
var _inherits2 = _interopRequireDefault(__webpack_require__(6));
        ...
        /**
         * TODO: ViewsOptions
         * @typedef {(Marionette.View|Marionette.CompositeView|BaseElementView|SectionView)}
         *     ViewsOptions
         */
var Container =
/*#__PURE__*/
function (_ArgsObject) {
    ...
    (0, _createClass2.default)(Container, [{
        ...
        value: function lookup() {
            ...
            if (lookup) {
                result = lookup.getContainer(); // Hack For repeater item the
                                                // result is the parent
                                                // container.
