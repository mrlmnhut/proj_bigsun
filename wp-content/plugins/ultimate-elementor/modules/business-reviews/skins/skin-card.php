...
class Skin_Card extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-business-reviews/card_section_info_controls/before_section_end',
			[$this, 'update_image_controls']);

		add_action('elementor/element/uael-business-reviews/card_section_date_controls/before_section_end',
			[$this, 'register_update_date_controls']);

		add_action('elementor/element/uael-business-reviews/card_section_styling/before_section_end',
			[$this, 'update_box_style_controls']);

		add_action('elementor/element/uael-business-reviews/card_section_spacing/before_section_end',
