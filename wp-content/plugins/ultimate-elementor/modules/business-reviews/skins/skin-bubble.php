...
class Skin_Bubble extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-business-reviews/bubble_section_info_controls/before_section_end',
			[$this, 'update_image_controls']);

		add_action('elementor/element/uael-business-reviews/bubble_section_date_controls/before_section_end',
			[$this, 'update_date_controls']);

		add_action('elementor/element/uael-business-reviews/bubble_section_content_controls/before_section_end',
			[$this, 'update_content_controls']);

		add_action('elementor/element/uael-business-reviews/bubble_section_styling/before_section_end',
			[$this, 'update_box_style_controls']);

		add_action('elementor/element/uael-business-reviews/bubble_section_spacing/before_section_end',
			[$this, 'update_spacing_controls']);
