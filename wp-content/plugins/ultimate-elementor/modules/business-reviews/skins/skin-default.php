...
class Skin_Default extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-business-reviews/default_section_info_controls/before_section_end',
			[$this, 'update_image_controls']);

		add_action('elementor/element/uael-business-reviews/default_section_styling/before_section_end',
