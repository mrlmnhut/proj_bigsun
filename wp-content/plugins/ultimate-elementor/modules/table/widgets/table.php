...
class Table extends Common_Widget{
	...
	protected function register_header_content_controls(){
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Note: Facing issue with %1$sCSV importer?%2$s Please read %3$sthis%2$s article for troubleshooting steps.',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-table-by-uploading-csv/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>',
						'<a href="https://uaelementor.com/docs/facing-issues-with-csv-import/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">'),
		...
		$repeater->add_control(
			...
			[
				...
				'type'      => Controls_Manager::RAW_HTML,
				'raw'       => sprintf('<p style="font-size: 12px;font-style: italic;line-height: 1.4;color: #a4afb7;">%s</p>',
					__('You have started a new row. Please add new cells in your row by clicking <b>Add Item</b> button below.',
						'uael')),
				'condition' => [
	...
	protected function register_header_style_controls(){
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw'  => sprintf('<p style="font-size: 12px;font-style: italic;line-height: 1.4;color: #a4afb7;">%s</p>',
					__('Note: By default, the border will be applied to cells. You can change it to row by using the above setting.',
						'uael')),
			]
		);
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/table-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started video » %2$s', 'uael'),
						'<a href="https://www.youtube.com/watch?v=wwu4ZzXrhGc&index=15&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s How to add rows & columns? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-rows-and-columns-to-the-table/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s How to add table header? » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-table-header-with-table-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s How to add content in table cell? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-table-content-with-table-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Table styling » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-to-style-the-table/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Row / Column span » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-to-merge-columns-and-rows-in-table/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Custom Column Width » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-custom-width-to-table-columns/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Create table by uploading CSV » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-table-by-uploading-csv/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Facing issues with CSV import? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/facing-issues-with-csv-import/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Sortable / Searchable table » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-sortable-and-searchable-table-how-to-show-entries-dropdown/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Control on table entries display count » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-sortable-and-searchable-table-how-to-show-entries-dropdown/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
	...
	protected function parse_csv(){
		...
		if (is_readable($file)){
			...
			if (!$_file){
				return [
					'html' => __("File could not be opened. Check the file's permissions to make sure it's readable by your server.",
						'uael'),
					'rows' => '',
				];
			}
			...
			if ($header_val){
                ...
                <tr <?php echo $this->get_render_attribute_string('uael_table_row'); ?>>
					...
					foreach ($header_val as $hkey => $head){
						...
						$repeater_heading_text = $this->get_repeater_setting_key('heading_text',
							'table_headings', $inline_count);
						$this->add_render_attribute($repeater_heading_text, 'class',
							'uael-table__text-inner');

						// TH.
						if (TRUE === $first_row_h){
							$this->add_render_attribute('current_' . $hkey, 'data-sort',
								$cell_counter_h);
						}
						$this->add_render_attribute('current_' . $hkey, 'class', 'sort-this');
						$this->add_render_attribute('current_' . $hkey, 'class',
							'elementor-repeater-item-' . $hkey);
						$this->add_render_attribute('current_' . $hkey, 'class', 'uael-table-col');
						// Sort Icon.
						if ('yes' === $settings['sortable'] && TRUE === $first_row_h){
							$this->add_render_attribute('icon_sort_' . $hkey, 'class',
								'uael-sort-icon');
						}
			...
			foreach ($rows as $row_key => $row){
                ...
                <tr data-entry="<?php echo $row_key + 1; ?>" <?php echo $this->get_render_attribute_string('uael_table_row'); ?>>
					...
					foreach ($row as $bkey => $col){
						...
						$repeater_cell_text = $this->get_repeater_setting_key('cell_text',
							'table_content', $cell_inline_count);
						$this->add_render_attribute($repeater_cell_text, 'class',
							'uael-table__text-inner');

						$this->add_render_attribute('uael_table_col' . $bkey, 'class',
							'uael-table-col');
						$this->add_render_attribute('uael_table_col' . $bkey, 'class',
							'elementor-repeater-item-' . $bkey);

						// Fetch corresponding header cell text.
						if (isset($header_text[$cell_counter]) && $header_text[$cell_counter]){
							$this->add_render_attribute('uael_table_col' . $bkey, 'data-title',
								$header_text[$cell_counter]);
						}
						?>
	...
	public function render_row_icon($row){
		...
		<?php if (UAEL_Helper::is_elementor_updated()){ ?><?php
			...
			<?php } ?><?php }elseif (isset($row['cell_icon'])){ ?>
            <span <?php echo $this->get_render_attribute_string('uael_cell_icon_align' . $row['_id']); ?>>
				<i class="<?php echo $row['cell_icon']; ?>"></i>
			</span>
			<?php
	...
	public function render_heading_icon($head){
		...
		<?php if (UAEL_Helper::is_elementor_updated()){ ?><?php
			...
			?><?php if (isset($head['heading_icon']) || isset($head['new_heading_icon'])){ ?>
                <span <?php echo $this->get_render_attribute_string('uael_heading_icon_align' . $head['_id']); ?>>
					...
					if ($head_icon_migrated || $head_icon_is_new){
						\Elementor\Icons_Manager::render_icon($head['new_heading_icon'],
							['aria-hidden' => 'true']);
					}else{
						?>
			...
			<?php } ?><?php }elseif (isset($head['heading_icon'])){ ?>
            <span <?php echo $this->get_render_attribute_string('uael_heading_icon_align' . $head['_id']); ?>>
				<i class="<?php echo $head['heading_icon']; ?>"></i>
			</span>
			<?php
