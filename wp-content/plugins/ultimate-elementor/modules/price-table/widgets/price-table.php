...
class Price_Table extends Common_Widget{
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => __('The raised option will add a Subscript / Superscript design to the fractional part of the Price.',
						'uael'),
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/price-box-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started video » %2$s', 'uael'),
						'<a href="https://www.youtube.com/watch?v=TJmcPWToHU0&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc&index=10" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Price Box styles » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/what-are-different-style-options-for-price-box/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Price value & Currency styling » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/normal-and-raised-format-for-price/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Content / Features area styling » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/box-and-stripped-layouts-for-content-in-price-box/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Ribbon styles » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/different-ribbon-styles-for-price-box/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Hover Animation effects » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/hover-animation-effects-for-price-box/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	public function render_button_icon($settings, $position){
		$this->add_render_attribute('button_icon', 'class',
			'uael-cta-link-icon uael-cta-link-icon-' . $position);
		if (UAEL_Helper::is_elementor_updated()){
			...
			if (!empty($settings['cta_icon']) || !empty($settings['new_cta_icon'])){
                ...
                <span <?php echo $this->get_render_attribute_string('button_icon'); ?>>
					...
					if ($cta_is_new || $cta_migrated){
						\Elementor\Icons_Manager::render_icon($settings['new_cta_icon'],
							['aria-hidden' => 'true']);
					}else{
						?>
			...
			<?php } ?><?php }elseif (!empty($settings['cta_icon'])){ ?>
            <span <?php echo $this->get_render_attribute_string('button_icon'); ?>>
				<i class="<?php echo $settings['cta_icon']; ?>" aria-hidden="true"></i>
			</span>
			<?php
	...
	public function render_button($settings){
		if ('link' === $settings['price_cta_type']){
            ...
            <a <?php echo $this->get_render_attribute_string('cta_link'); ?>>
				<?php if ('left' === $settings['cta_icon_position']){ ?><?php $this->render_button_icon($settings,
					'before'); ?><?php } ?>
				<?php
	...
	public function render_heading_text($settings){
		if ($settings['heading']) :
			if (!empty($settings['heading'])) :
				?>
                <div class="uael-price-heading-text">                    <<?php echo $settings['heading_tag']; ?> class="uael-price-table-heading elementor-inline-editing" data-elementor-setting-key="heading" data-elementor-inline-editing-toolbar="basic"><?php echo $settings['heading']; ?>
                </<?php echo $settings['heading_tag']; ?>>                </div>
			<?php
			endif;
		endif;
	}
			...
			if ($settings['heading'] || $settings['sub_heading']) :
                ...
                <div class="uael-price-table-header">
                    <div class="uael-pricing-heading-wrap">
						<?php $this->render_heading_text($settings); ?><?php $this->render_subheading_text($settings); ?>
                    </div>
                </div>
			<?php
			endif;
            ...
            <div class="uael-price-table-pricing">
                <div class="uael-pricing-container">
                    <div class="uael-pricing-value">
						...
						<?php if (!empty($intvalue) || 0 <= $intvalue) : ?><?php if (!empty($symbol) && ',' === $settings['currency_format']) : ?>
						...
						<?php if ('' !== $fraction || (!empty($settings['duration']) && 'beside' === $duration_position)) : ?>
                            <span class="uael-price-table-beside-price">
								...
								<?php if (!empty($settings['duration']) && 'beside' === $duration_position && '3' !== $settings['pricetable_style']) : ?><?php echo $duration_element; ?><?php endif; ?>
							</span>
						<?php endif; ?>
                    </div>
					<?php if (!empty($settings['duration'])) : ?><?php if ('3' === $settings['pricetable_style'] || 'below' === $settings['duration_position']) : ?>
	...
	public function render_features($settings){
		...
		if (!empty($settings['features_list'])) :
            ...
            <ul class="uael-price-table-features-list">
				<?php foreach ($settings['features_list'] as $index => $item) : ?><?php
					$title_key = $this->get_repeater_setting_key('item_text', 'features_list',
						$index);
							...
							if (UAEL_Helper::is_elementor_updated()){
								...
								if ($has_icon) :
									...
									if ($features_marker_migrated || $features_marker_is_new){
										\Elementor\Icons_Manager::render_icon($item['new_item_icon'],
											['aria-hidden' => 'true']);
								...
								<?php endif; ?><?php }elseif (!empty($item['item_icon'])){ ?>
                                <i class="<?php echo esc_attr($item['item_icon']); ?>" aria-hidden="true"></i>
							<?php } ?>
							<?php
		...
		if ('none' !== $settings['price_cta_type'] || !empty($settings['footer_additional_info'])) :
			if (!empty($settings['cta_text']) || !empty($settings['footer_additional_info']) || !empty($settings['cta_icon']) || !empty($settings['new_cta_icon'])) :
                ...
                <div class="uael-price-table-cta">
					<?php if ('none' !== $settings['price_cta_type']) : ?><?php $this->render_button($settings); ?><?php endif; ?>
	...
	public function render_ribbon($settings){
		...
		if (!empty($settings['ribbon_title'])) :
			if ('none' !== $settings['show_ribbon']) :
				...
				$this->add_render_attribute('ribbon-wrapper', 'class',
					'uael-price-table-ribbon-' . $ribbon_style);

				if (!empty($settings['ribbon_horizontal_position'])) :
					$this->add_render_attribute('ribbon-wrapper', 'class',
						'uael-ribbon-' . $settings['ribbon_horizontal_position']);
				endif;
	...
	protected function _content_template(){
		?>
        <#        function render_heading_text() {            if ( settings.heading ) {                if ( '' != settings.heading ) {                    #>
        ...
        </{{ settings.heading_tag }}>                    </div>                    <#                }            }        }        function render_subheading_text() {            if ( settings.sub_heading ) {                if ( '' != settings.sub_heading || '' != settings.sub_heading_style2 ) {                #>
        <div class="uael-price-subheading-text">
        ...
        </{{ settings.sub_heading_tag_style2 }}>                        <# } else { #>                            <{{ settings.sub_heading_tag }} class="uael-price-table-subheading elementor-inline-editing" data-elementor-setting-key="sub_heading" data-elementor-inline-editing-toolbar="basic">                                {{{ settings.sub_heading }}}                            </{{ settings.sub_heading_tag }}>                        <# } #>                    </div>                <#                }            }        }

        function render_style_header() {

        if ( '2' == settings.pricetable_style ) {                if ( settings.heading ) {                    #>
        <div class="uael-price-table-header">
            <{{{ settings.heading_tag }}} class="uael-price-table-heading elementor-inline-editing" data-elementor-setting-key="heading" data-elementor-inline-editing-toolbar="basic">{{{ settings.heading }}}
        </{{{ settings.heading_tag }}}>                    </div>                    <#                }            } else {                if ( settings.heading || settings.sub_heading ) {                    #>
        <div class="uael-price-table-header">
            <div class="uael-pricing-heading-wrap">
                <# render_heading_text(); #>
        ...
        function render_price() {            var symbol = '';

        var symbols = {                dollar: '&#36;',                euro: '&#128;',                franc: '&#8355;',                pound: '&#163;',                ruble: '&#8381;',                shekel: '&#8362;',                baht: '&#3647;',                yen: '&#165;',                won: '&#8361;',                guilder: '&fnof;',                peso: '&#8369;',                peseta: '&#8359;',                lira: '&#8356;',                rupee: '&#8360;',                indian_rupee: '&#8377;',                real: 'R$',                krona: 'kr'            };

        if ( settings.currency_symbol ) {                if ( 'custom' !== settings.currency_symbol ) {                    symbol = symbols[ settings.currency_symbol ] || '';                } else {                    symbol = settings.currency_symbol_custom;                }            }

        var currencyFormat = settings.currency_format || '.',                table_price = settings.price.toString(),                price = table_price.split( currencyFormat ),                intvalue = price[0],                fraction = price[1];

        var    durationText = '
        <span class="uael-price-table-duration uael-price-typo-excluded elementor-inline-editing" data-elementor-setting-key="duration" data-elementor-inline-editing-toolbar="basic">' + settings.duration + '</span>';            #>
        <div class="uael-price-table-price-wrap">
            <div class="uael-price-table-pricing">
                <div class="uael-pricing-container">
                    <div class="uael-pricing-value">
        ...
        function render_features() {            var iconsHTML = {};            if ( settings.features_list ) { #>
        <ul class="uael-price-table-features-list">
            ...
            <li class="elementor-repeater-item-{{ item._id }}">
                <div class="uael-price-table-feature-content">
					<?php if (UAEL_Helper::is_elementor_updated()){ ?>
                        <# if ( item.item_icon || item.new_item_icon ) { #>                                        <#                                        iconsHTML[ index ] = elementor.helpers.renderIcon( view, item.new_item_icon, { 'aria-hidden': true }, 'i' , 'object' );                                        migrated = elementor.helpers.isIconMigrated( item, 'new_item_icon' ); #>

                        <# if ( ( ! item.item_icon || migrated ) && iconsHTML[ index ] && iconsHTML[ index ].rendered ) { #>                                            {{{ iconsHTML[ index ].value }}}                                        <# } else if( '' !== item.item_icon ) { #>
        ...
        function render_cta_icon( position ) {            view.addRenderAttribute( 'button_icon', 'class', 'uael-cta-link-icon uael-cta-link-icon-' + position ); #>
		<?php if (UAEL_Helper::is_elementor_updated()){ ?>
            <# if ( settings.cta_icon || settings.new_cta_icon ) {  #>                <#                var cta_iconHTML = elementor.helpers.renderIcon( view, settings.new_cta_icon, { 'aria-hidden': true }, 'i' , 'object' );                var cta_migrated = elementor.helpers.isIconMigrated( settings, 'new_cta_icon' );                #>
            <span {{{ view.getRenderAttributeString( 'button_icon' ) }}}>                        <# if ( cta_iconHTML && cta_iconHTML.rendered && ( ! settings.cta_icon || cta_migrated ) ) {                        #>                            {{{ cta_iconHTML.value }}}                        <# } else { #>
            <i class="{{ settings.cta_icon }}" aria-hidden="true"></i>                        <# } #>                    </span>                <# } #>
		<?php }else{ ?>
        ...
        function render_cta() {            if ( 'none' != settings.price_cta_type || '' != settings.footer_additional_info ) {                if ( settings.cta_text || settings.cta_icon || settings.new_cta_icon || settings.footer_additional_info ) { #>
        <div class="uael-price-table-cta">
            <#
        ...
        </div>                            <# } #>                        <# } #>                        <# if ( settings.footer_additional_info ) { #>
        <div class="uael-price-table-disclaimer elementor-inline-editing" data-elementor-setting-key="footer_additional_info" data-elementor-inline-editing-toolbar="basic">{{{ settings.footer_additional_info }}}</div>                        <# } #>                    </div>                <# }            }        }

        function render_separator() {            if ( settings.features_list ) {                if ( 'yes' == settings.pricetable_separator && '2' == settings.pricetable_style ) {                #>
        <div class="uael-separator-parent">
            <div class="uael-separator"></div>
        </div>                <# }            }        }

        function render_ribbon() {        var ribbon_style = '';        if ( '' != settings.ribbon_title ) {            if ( 'none' != settings.show_ribbon ) {

        if ( '1' == settings.show_ribbon ) {                    ribbon_style = '1';                } else if ( '2' == settings.show_ribbon ) {                    ribbon_style = '2';                } else if ( '3' == settings.show_ribbon ) {                    ribbon_style = '3';                }                var ribbonClass = '';

        if ( settings.ribbon_horizontal_position ) {                    ribbonClass = 'uael-ribbon-' + settings.ribbon_horizontal_position;                } #>
        ...
        <div class="uael-module-content uael-price-table-container uael-pricing-style-{{ settings.pricetable_style }}">
            ...
            <# render_ribbon(); #>
        </div>        <# } else if ( '2' == settings.pricetable_style ) { #>
        <div class="uael-module-content uael-price-table-container uael-pricing-style-{{ settings.pricetable_style }}">
            <div class="uael-price-table">
                <# render_style_header(); #>
                <# render_price(); #>
            ...
            <# render_ribbon(); #>
        </div>        <# } else if ( '3' == settings.pricetable_style ) { #>
        <div class="uael-module-content uael-price-table-container uael-pricing-style-{{ settings.pricetable_style }}">
            <div class="uael-price-table">
                <# render_style_header(); #>
                <# render_price(); #>
