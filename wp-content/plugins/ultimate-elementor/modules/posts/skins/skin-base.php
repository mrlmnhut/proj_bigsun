...
abstract class Skin_Base extends Elementor_Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-posts/section_filter_field/after_section_end',
			[$this, 'register_sections']);

		add_action('elementor/element/uael-posts/section_layout/after_section_end',
			[$this, 'register_sections_before']);
	}
	...
	public function register_content_general_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Note: <b>Posts Per Page</b> should be greater than <b>Columns</b>.',
					'uael'),
		...
		$this->add_control(
			...
			[
				...
				'raw'             => __('Note: Infinite Pagination will not work when query type is set to Main Query',
					'uael'),
				'condition'       => [
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SWITCHER,
				'description'  => __('Enable this to display all posts with same height on carousel scroll.',
					'uael'),
				'return_value' => 'yes',
				'default'      => '',
				'condition'    => [
	...
	public function register_content_image_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Crop the original image size to any custom size. Set custom width or height to keep the original size ratio.',
					'uael'),
				'default'     => [
					'width'  => '',
					'height' => '',
		...
		$this->add_control(
			...
			[
				...
				'label_on'     => __('Yes', 'uael'),
				'label_off'    => __('No', 'uael'),
				'description'  => __('Disable this option, if you do not wish to make the image clickable.',
					'uael'),
				'return_value' => 'yes',
				'default'      => 'yes',
				'separator'    => 'before',
	...
	public function register_content_title_controls(){
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('Yes', 'uael'),
				'description'  => __('Disable this option, if you do not wish to make the title clickable.',
					'uael'),
				'label_off'    => __('No', 'uael'),
				'return_value' => 'yes',
				'default'      => 'yes',
	...
	public function register_content_meta_controls(){
		...
		$this->add_control(
			...
			[
				...
				'label_on'     => __('Yes', 'uael'),
				'label_off'    => __('No', 'uael'),
				'description'  => __('Disable this option, if you do not wish to make the meta clickable.',
					'uael'),
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition'    => [
