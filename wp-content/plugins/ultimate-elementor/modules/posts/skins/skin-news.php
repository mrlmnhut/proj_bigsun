...
class Skin_News extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-posts/news_section_title_field/before_section_end',
			[$this, 'register_update_title_controls']);

		add_action('elementor/element/uael-posts/news_section_excerpt_field/before_section_end',
			[$this, 'register_update_excerpt_controls']);

		add_action('elementor/element/uael-posts/news_section_cta_field/before_section_end',
			[$this, 'register_update_cta_controls']);

		add_action('elementor/element/uael-posts/news_section_image_field/before_section_end',
			[$this, 'register_update_image_controls']);

		add_action('elementor/element/uael-posts/news_section_general_field/before_section_end',
			[$this, 'register_update_general_controls']);

		add_action('elementor/element/uael-posts/news_section_design_layout/before_section_end',
			[$this, 'register_update_layout_controls']);

		add_action('elementor/element/uael-posts/news_section_title_style/before_section_end',
			[$this, 'register_update_title_style_controls']);
	}
	...
	public function register_update_image_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description'  => __('Enable this option to stack post image and content on mobile.',
					'uael'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('Yes', 'uael'),
				'label_off'    => __('No', 'uael'),
