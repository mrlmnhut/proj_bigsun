...
class Skin_Feed extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-posts/feed_section_general_field/before_section_end',
			[$this, 'register_update_general_controls']);

		add_action('elementor/element/uael-posts/feed_section_image_field/before_section_end',
			[$this, 'register_update_image_controls']);

		add_action('elementor/element/uael-posts/feed_section_design_blog/before_section_end',
			[$this, 'register_blog_design_controls']);

		add_action('elementor/element/uael-posts/feed_section_design_layout/before_section_end',
			[$this, 'register_update_layout_controls']);

		add_action('elementor/element/uael-posts/feed_section_meta_field/before_section_end',
			[$this, 'register_update_meta_field_controls']);

		add_action('elementor/element/uael-posts/feed_section_cta_field/before_section_end',
			[$this, 'register_update_cta_controls']);

		add_action('elementor/element/uael-posts/feed_section_meta_style/before_section_end',
			[$this, 'register_update_meta_styles_controls']);

		add_action('elementor/element/uael-posts/feed_section_title_style/before_section_end',
			[$this, 'register_update_title_styles_controls']);
	}
	...
	public function register_style_pagination_controls(){
		...
		$this->add_control(
			...
			[
				...
				'raw'             => __('Note: Infinite Load is prevented at the backend. You can see it working in the frontend.',
					'uael'),
				'condition'       => [
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __('Note: This Loader is visible only when user clicks on Load More button.',
					'uael'),
				'condition'       => [
					$this->get_control_id('pagination')     => 'infinite',
					$this->get_control_id('infinite_event') => 'click',
