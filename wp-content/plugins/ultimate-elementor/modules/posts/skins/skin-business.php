...
class Skin_Business extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-posts/business_section_image_field/before_section_end',
			[$this, 'register_update_image_controls']);

		add_action('elementor/element/uael-posts/business_section_meta_field/before_section_end',
			[$this, 'register_update_meta_controls']);

		add_action('elementor/element/uael-posts/business_section_excerpt_field/before_section_end',
			[$this, 'register_update_excerpt_controls']);

		add_action('elementor/element/uael-posts/business_section_cta_field/before_section_end',
			[$this, 'register_update_cta_controls']);

		add_action('elementor/element/uael-posts/business_section_design_blog/before_section_end',
			[$this, 'register_update_blog_controls']);

		add_action('elementor/element/uael-posts/business_section_design_layout/before_section_end',
			[$this, 'register_update_layout_controls']);

		add_action('elementor/element/uael-posts/business_section_general_field/before_section_end',
			[$this, 'register_update_general_controls']);

		add_action('elementor/element/uael-posts/business_section_title_style/before_section_end',
			[$this, 'register_update_title_style']);

		add_action('elementor/element/uael-posts/business_section_featured_field/before_section_end',
			[$this, 'register_update_featured_style']);
