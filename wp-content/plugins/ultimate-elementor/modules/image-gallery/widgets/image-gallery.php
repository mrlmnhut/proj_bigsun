...
class Image_Gallery extends Common_Widget{
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Learn : %1$s How to design filterable image gallery? %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-design-filterable-image-gallery/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Note: Enter the category name that you wish to set as a default on page load. Read %1$s this article %2$s for more information.',
						'uael'),
						'<a href="https://uaelementor.com/docs/display-specific-category-tab-as-a-default/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'default_filter_switch'  => 'yes',
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s admin link */
					'raw'             => sprintf(__('Learn : %1$s How to assign custom link for images? %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-set-a-custom-link-for-the-image/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'click_action' => 'custom',
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s admin link */
					'raw'             => sprintf(__('Learn : %1$s How to assign captions for images? %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-a-caption-for-the-image/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'gallery_caption!' => '',
	...
	protected function register_content_lightbox_controls(){
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Click %1$s here %2$s to learn more about this.',
						'uael'),
						'<a href="https://uaelementor.com/docs/image-gallery-widget/#advanced-lightbox-actions/" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'description'  => __('Enable this option to display the caption under the image in Lightbox.',
					'uael'),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'label_on'     => __('Yes', 'uael'),
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/image-gallery-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started video » %2$s', 'uael'),
						'<a href="https://www.youtube.com/watch?v=7Q-3fAKKhbg&index=11&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Design filterable Image Gallery » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-design-filterable-image-gallery/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Open lightbox on the click of an image » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/image-gallery-widget/#open-lightbox" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Open a webpage on the click of an image » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-open-a-webpage-with-the-click-of-an-image/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Apply scale, opacity, overlay, effects to images » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-to-customize-images/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Display specific category tab as a default on page load » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/display-specific-category-tab-as-a-default/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Set icon on image hover » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-to-set-icon-on-image-hover/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Display Caption below image in the lightbox » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/image-gallery-widget/#caption-below-image-of-lightbox" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function render_image_thumbnail($image){
		...
		$output .= Group_Control_Image_Size::get_attachment_image_html($settings, 'image',
			'image_index');
			...
			if (UAEL_Helper::is_elementor_updated()){
				...
				if ($has_icon){
					...
					if ($is_new || $migrated){
						...
						ob_start();
						\Elementor\Icons_Manager::render_icon($settings['new_overlay_icon_hover'],
							['aria-hidden' => 'true']);
						$output .= ob_get_clean();
	...
	protected function render_gallery_image($images){
		...
		foreach ($new_gallery as $index => $item){
			...
			if ('justified' === $settings['gallery_style']){
				...
				$output .= '<div class="uael-grid-item ' . implode(' ',
						$image_cat) . ' uael-img-gallery-item-' . ($index + 1) . '">';
				$output .= '<div class="uael-grid-item-content">';
				$output .= '<' . $img_wrap_tag . ' ' . $this->get_render_attribute_string('grid-media-' . $index) . '>';
	...
	protected function render(){
		...
		$this->add_render_attribute('grid-wrap', 'data-filter-default',
