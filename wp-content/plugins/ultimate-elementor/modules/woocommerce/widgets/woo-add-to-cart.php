...
class Woo_Add_To_Cart extends Common_Widget{
	...
	protected function register_content_product_controls(){
		...
		if (defined('ELEMENTOR_PRO_VERSION')){
			...
			$this->add_control(
				...
				[
					...
					'description'  => __('Enable this option to use Add to Cart button on the single product page.',
						'uael'),
		...
		$this->add_control(
			...
			[
				...
				'return_value' => 'yes',
				'default'      => '',
				'description'  => __('Enable this option to redirect cart page after the product gets added to cart',
					'uael'),
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-to-add-woocommerce-add-to-cart-button-on-the-page/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
	...
	protected function render(){
		...
		$product = !empty($product_data) && in_array($product_data->post_type,
			['product', 'product_variation'], TRUE) ? wc_setup_product_data($product_data) : FALSE;
