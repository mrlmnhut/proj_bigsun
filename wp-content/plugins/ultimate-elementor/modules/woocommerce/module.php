...
class Module extends Module_Base{
	...
	public function js_localize($localize){
		...
		$localize['cart_url']          = apply_filters('uael_woocommerce_add_to_cart_redirect',
			wc_get_cart_url());
	...
	public function quick_view_content_actions(){
		...
		// Image.
		add_action('uael_woo_quick_view_product_image', [$this, 'quick_view_product_images_markup'],
			20);

		// Summary.
		add_action('uael_woo_quick_view_product_summary',
			[$this, 'quick_view_product_content_structure'], 10);
	}
	...
	public function __construct(){
		...
		add_filter('uael_js_localize', [$this, 'js_localize']);

		// quick view ajax.
		add_action('wp_ajax_uael_woo_quick_view', [$this, 'load_quick_view_product']);
		add_action('wp_ajax_nopriv_uael_woo_quick_view', [$this, 'load_quick_view_product']);

		add_action('wp_ajax_uael_add_cart_single_product', [$this, 'add_cart_single_product_ajax']);
		add_action('wp_ajax_nopriv_uael_add_cart_single_product',
			[$this, 'add_cart_single_product_ajax']);

		add_action('wp_ajax_uael_get_products', [$this, 'uael_get_products']);
		add_action('wp_ajax_nopriv_uael_get_products', [$this, 'uael_get_products']);
	}
