...
abstract class Skin_Grid_Base extends Skin_Base{
	...
	protected function _register_controls_actions(){
		...
		add_action('elementor/element/uael-woo-products/section_filter_field/after_section_end',
			[$this, 'register_quick_view_controls'], 20);
		add_action('elementor/element/uael-woo-products/section_design_image/after_section_end',
			[$this, 'register_quick_view_style_controls'], 20);
	}
	...
	public function register_quick_view_controls(Widget_Base $widget){
		...
		$this->add_control(
			...
			[
				...
				'raw'             => __('Note: Enable the Show Image switch to display the quick view option on image hover.',
					'uael'),
				'condition'       => [
