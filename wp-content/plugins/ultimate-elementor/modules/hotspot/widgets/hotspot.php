...
class Hotspot extends Common_Widget{
	...
	protected function register_hotspot_content_controls(){
		...
		$repeater->add_control(
			...
			[
				...
				'description' => __('Note: Applicable only when tooltips trigger is set to Hover. Also, when Hotspot Tour option is enabled link will not work',
					'uael'),
	...
	protected function register_hotspot_tour_controls(){
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf('Note: Tour autoplay option will only work on the frontend.',
						'uael'),
		...
		$this->add_control(
			...
			[
				...
				'description'        => __('Next tooltip will be displayed after this time interval',
					'uael'),
				'type'               => Controls_Manager::SLIDER,
				'range'              => [
					'sec' => [
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/hotspot-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s How Hotspot Tour works? » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/how-hotspot-tour-works/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s Styling a Marker in Hotspot widget » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/styling-hotspot-marker/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s Unable to access the URL assigned to marker? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/unable-to-access-the-url-assigned-to-marker/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s How Max-height option works? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/how-max-height-option-works/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s Unable to click on markers when Hotspot Tour option is enabled? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/unable-to-click-on-markers/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Filters/Actions » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/filters-actions-for-hotspot-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function register_tooltip_content_controls(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'description'        => __('Note: If Tooltip Content is large, a vertical scroll will appear. Set Max Height to manage the content window height.',
					'uael'),
				'type'               => Controls_Manager::SLIDER,
				'range'              => [
					'px' => [
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Note: Increase the z-index value if you are unable to see the tooltip. For example - 99, 999, 9999 ',
					'uael'),
	...
	protected function render(){
        ...
        <div class="uael-hotspot <?php echo $tour_enable . ' ' . $tooltip_enable; ?> ">
			...
			if ($settings['hotspots_list']) :
                ...
                <div class="uael-hotspot-container" <?php echo $this->get_data_attrs($settings,
					$device); ?>>
					...
					foreach ($settings['hotspots_list'] as $index => $item) :
						...
						$hotspot_img = FALSE;
						$tooltip_data = $this->get_repeater_setting_key('content', 'hotspots_list',
							$index);
						$content_id = $this->get_id() . '-' . $item['_id'];
						$hotspot_glow = '';

						if (!empty($item['marker_link']['url'])){
							$this->add_render_attribute('url-' . $item['_id'], 'href',
								$item['marker_link']['url']);

							if ($item['marker_link']['is_external']){
								$this->add_render_attribute('url-' . $item['_id'], 'target',
									'_blank');
							}

							if (!empty($item['marker_link']['nofollow'])){
								$this->add_render_attribute('url-' . $item['_id'], 'rel',
									'nofollow');
							}
						...
						if ('image' === $item['hotspot'] && !empty($item['repeater_image'])){
							...
							$this->add_render_attribute('hotspot_image' . $index, 'src',
								$item['repeater_image']['url']);
							$this->add_render_attribute('hotspot_image' . $index, 'class',
								'uael-hotspot-img image-' . $index);
						...
						?><?php if (!empty($item['marker_link']['url'])){ ?><?php if ('yes' === $settings['hotspot_tooltip_data']){ ?><?php if ('yes' !== $settings['hotspot_tour'] && 'hover' === $settings['trigger']){ ?>
                        <a <?php echo $link; ?> >
					<?php } ?><?php }else{ ?>
                        <a <?php echo $link; ?> >
					<?php } ?><?php } ?>
							...
							if ('icon' === $item['hotspot']){
								if (UAEL_Helper::is_elementor_updated()){
									...
									if ($marker_migrated || $marker_is_new){
										\Elementor\Icons_Manager::render_icon($item['new_icon'],
											['aria-hidden' => 'true']);
									}elseif (!empty($item['icon'])){
										$icon_data = 'icon-' . $index;
										$this->add_render_attribute($icon_data, 'class',
											esc_attr($item['icon']));
										?>
					...
					<?php } ?><?php } ?>
						...
						$next           = apply_filters('uael_hotspot_next_label', $next_label,
							$settings);
						$previous       = apply_filters('uael_hotspot_previous_label',
							$previous_label, $settings);
						$end            = apply_filters('uael_hotspot_endtour_label',
							$endtour_label, $settings);
                        ...
                        <span class="uael-tooltip-container">
							<span <?php echo $this->get_render_attribute_string($tooltip_data); ?>><?php echo $this->parse_text_editor($item['content']); ?>
								<span class="uael-tour"><span class="uael-actual-step"><?php echo $counter; ?><?php echo __('of',
											'uael'); ?><?php echo sizeof($settings['hotspots_list']); ?></span><ul><li><a href="#0" class="uael-prev-<?php echo $node_id; ?>" data-tooltipid="<?php echo $counter; ?>">&#171; <?php echo $previous; ?></a></li><li><a href="#0" class="uael-next-<?php echo $node_id; ?>" data-tooltipid="<?php echo $counter; ?>"><?php echo $next; ?> &#187;</a></li></ul></span>
								<?php
								if ('yes' === $settings['hotspot_tour_autoplay'] && 'yes' === $settings['hotspot_tour_repeat']){
									?>
                                    <span class="uael-hotspot-end">
                                    <a href="#" class="uael-tour-end-<?php echo $node_id; ?>"><?php echo $end; ?></a>
                                    </span><?php } ?>
							</span>
						</span>
					<?php } ?><?php
			...
			<?php if ('yes' === $settings['hotspot_tour'] && 'yes' === $settings['hotspot_tour_autoplay'] && 'yes' === $settings['hotspot_tooltip_data'] && 'click' === $settings['autoplay_options']){ ?><?php
				$this->add_render_attribute('button', 'class', 'elementor-button');
				if (!empty($settings['overlay_button_size'])){
					$this->add_render_attribute('button', 'class',
						'elementor-size-' . $settings['overlay_button_size']);
				}
				?>
	...
	protected function _content_template(){
        ...
        function data_attributes() {                var side            = settings.position;                var trigger            = '';                var tour_autoplay    = '';                var tour_repeat    = '';                var tour_overlay    = '';                var arrow            = settings.arrow;                var animation        = settings.tooltip_anim;                var zindex            = ( 'yes' == settings.hotspot_tooltip_adv ) ? settings.zindex : 99;                var interval_val    = settings.tour_interval.size;                var action_auto    = ( 'auto' == settings.autoplay_options ) ? 'auto' : '';
        ...
        if( '' == interval_val ) {                    tour_interval = 4000;                } else {                    tour_interval = interval_val * 1000;                }

        if ( 'yes' == settings.hotspot_tour && 'yes' == settings.hotspot_tooltip_data ) {                    trigger = 'custom';

        if ( 'yes' == settings.hotspot_tour_autoplay ) {                        tour_autoplay = 'yes';                        tour_overlay = ( 'click' == settings.autoplay_options ) ? 'yes' : 'no';

        if ( 'yes' == settings.hotspot_tour_repeat ) {                            tour_repeat = 'yes';                        } else {                            tour_repeat = 'no';                        }                    } else {                        tour_autoplay = 'no';                        tour_overlay = 'no';

        if ( 'yes' == settings.hotspot_tour_repeat ) {                            tour_repeat = 'yes';                        } else {                            tour_repeat = 'no';                        }                    }                } else {                    trigger = settings.trigger;                }

        var data_attr  = 'data-side="' + side + '" ';                    data_attr += 'data-hotspottrigger="' + trigger + '" ';                    data_attr += 'data-arrow="' + arrow + '" ';                    data_attr += 'data-distance="' + distance + '" ';                    data_attr += 'data-delay="' + delay + '" ';                    data_attr += 'data-animation="' + animation + '" ';                    data_attr += 'data-animduration="' + anim_duration + '" ';                    data_attr += 'data-zindex="' + zindex + '" ';                    data_attr += 'data-length="' + length + '" ';                    data_attr += 'data-autoplay="' + tour_autoplay + '" ';                    data_attr += 'data-repeat="' + tour_repeat + '" ';                    data_attr += 'data-tourinterval="' + tour_interval + '" ';                    data_attr += 'data-overlay="' + tour_overlay + '" ';                    data_attr += 'data-autoaction="' + action_auto + '" ';

        return data_attr;            }        #>        <# if ( '' !== settings.image.url ) {            var image = {                id: settings.image.id,                url: settings.image.url,                size: settings.image_size,                dimension: settings.image_custom_dimension,                model: view.getEditModel()            };            var image_url = elementor.imagesManager.getImageUrl( image );            var node_id = view.$el.data('id');            var hotspot_tour = '';            var tour_enable = '';            var hide_nonactive = '';

        var tooltip_enable = ( 'yes' == settings.hotspot_tooltip_data ) ? ' uael-hotspot-tooltip-yes' : '';

        if ( 'yes' == settings.hotspot_tour ) {                hotspot_tour = 'uael-tour-active';                tour_enable  = ' uael-hotspot-tour';            } else {                hotspot_tour = 'uael-tour-inactive';            }

        if( 'yes' == settings.hotspot_tour && 'yes' == settings.hotspot_nonactive_markers ) {                hide_nonactive = 'uael-hotspot-marker-nonactive';            }

        var iconsHTML = {};            #>            <# var param = data_attributes(); #>
        ...
        <div class="uael-hotspot{{ tour_enable }}{{ tooltip_enable }}">
            ...
            <div class="uael-hotspot-container" {{{ param }}}>
								...
								<span class="uael-hotspot-main-{{ node_id }} uael-hotspot-content{{ hotspot_glow }} {{ hide_nonactive }}" id="uael-tooltip-id-{{ node_id }}-{{ counter }}" data-uaeltour="{{ counter }}" data-tooltip-content="#uael-tooltip-content-{{ item._id }}">
									<# if ( 'icon' === item.hotspot ) { #>
										<?php if (UAEL_Helper::is_elementor_updated()){ ?>
                                            <#                                            iconsHTML[ index ] = elementor.helpers.renderIcon( view, item.new_icon, { 'aria-hidden': true }, 'i' , 'object' );                                            migrated = elementor.helpers.isIconMigrated( item, 'new_icon' ); #>                                            <# if ( ( ! item.icon || migrated ) && iconsHTML[ index ] && iconsHTML[ index ].rendered ) { #>                                                {{{ iconsHTML[ index ].value }}}                                            <# } else { #>
                ...
                <span class="uael-tooltip-container">
									<span class="uael-tooltip-text {{ hotspot_tour }}" id="uael-tooltip-content-{{ item._id }}">{{{ item.content }}}
										<span class="uael-tour"><span class="uael-actual-step">{{ counter }} of {{ length }}</span><ul><li><a href="#0" class="uael-prev-{{ node_id }}" data-tooltipid="{{ counter }}">&#171; <?php _e('Previous',
															'uael'); ?></a></li><li><a href="#0" class="uael-next-{{ node_id }}" data-tooltipid="{{ counter }}"><?php _e('Next',
															'uael'); ?> &#187;</a></li></ul></span>
									</span>
								</span>
                <# } #>
            ...
            <# } #>
        </div>        <# } #>        <# elementorFrontend.hooks.doAction( 'frontend/element_ready/uael-hotspot.default' ); #>
		<?php
	}
}
