...
class Countdown extends Common_Widget{
	...
	protected function register_countdown_general_controls(){
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Click <a href="%s" target="_blank" rel="noopener">here</a> to know more about the <span style="text-decoration:underline;font-weight:900;">Fixed Timer</span>.',
						'uael'),
						'https://uaelementor.com/docs/types-of-timers-in-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#fixed-timer'),
		...
		$this->add_control(
			...
			[
				...
				'default'     => gmdate('Y-m-d H:i',
					strtotime('+1 month') + (get_option('gmt_offset'))),
				/* translators: %s: Time zone. */
				'description' => sprintf(__('Date set according to your timezone: %s.', 'uael'),
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf(__('Click <a href="%s" target="_blank" rel="noopener">here</a> to know more about the <span style="text-decoration:underline;font-weight:900;">Evergreen Timer</span>.',
						'uael'),
						'https://uaelementor.com/docs/types-of-timers-in-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#evergreen-timer'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf(__('Click <a href="%s" target="_blank" rel="noopener">here</a> to know more about <span style="text-decoration:underline;font-weight:900;">Recurring Timer</span>.',
						'uael'),
						'https://uaelementor.com/docs/faqs-for-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#what-is-the-difference-between-evergreen-and-recurring-timer-and-how-does-the-recurring-timer-works-'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Which <a href="%s" target="_blank" rel="noopener">timezone</a> does the timer use?',
						'uael'),
						'https://uaelementor.com/docs/faqs-for-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#which-timezone-does-the-timer-use-'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'countdown_type' => 'fixed',
					],
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Select the date & time when you want to make your countdown timer go live on your site.',
					'uael'),
				'type'        => Controls_Manager::DATE_TIME,
				'label_block' => FALSE,
				'default'     => gmdate('Y-m-d H:i'),
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Set the above Days, Hours, Minutes fields for the amount of time you want the timer to display.',
					'uael'),
				'type'        => Controls_Manager::NUMBER,
				'dynamic'     => [
					'active' => TRUE,
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Note: This option will repeat the timer after sepcified number of days.',
					'uael'),
				'type'        => Controls_Manager::NUMBER,
				'dynamic'     => [
					'active' => TRUE,
	...
	protected function register_style_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description'  => __('Enable this option to stack the Countdown items on mobile.',
					'uael'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('On', 'uael'),
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/introducing-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s Know more about the types of timers » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/types-of-timers-in-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s What is the difference between Fixed, Evergreen timer? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/faqs-for-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#what-is-the-difference-between-fixed-evergreen-timer-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s What is the difference between Evergreen and Recurring Timer  » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/faqs-for-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#what-is-the-difference-between-evergreen-and-recurring-timer-and-how-does-the-recurring-timer-works-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s How does the Recurring Timer works? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/faqs-for-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#what-is-the-difference-between-evergreen-and-recurring-timer-and-how-does-the-recurring-timer-works-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf(__('%1$s Which timezone does the timer use? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/faqs-for-countdown-timer-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin#which-timezone-does-the-timer-use-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function render(){
		...
		$data_attributes = ['data-countdown-type', 'data-timer-labels', 'data-animation'];
		$data_values     = [$settings['countdown_type'], $settings['display_timer_labels'], $settings['start_animation']];

		$this->add_render_attribute('countdown-wrapper', 'class', 'uael-countdown-items-wrapper');

		$this->add_render_attribute('countdown', 'class',
			['uael-countdown-wrapper', 'countdown-active']);
		...
		if ('custom' === $settings['display_timer_labels']){
			for ($i = 0; $i < $length; $i ++){
				$this->add_render_attribute('countdown', 'data-timer-' . $labels[$i],
					$settings['custom_' . $labels[$i]]);
			}
		}
		...
		if ('fixed' === $settings['countdown_type']){
			...
			$this->add_render_attribute('countdown', 'data-evg-interval',
				$this->total_interval($settings));
		}
		...
		if ('redirect' === $settings['expire_actions']){
			$this->add_render_attribute('countdown', 'data-redirect-url',
			...
			$this->add_render_attribute('countdown', 'data-countdown-expire-message',
				$settings['preview_expire_message']);
		}
		...
		if ('evergreen' === $settings['countdown_type'] && 'yes' === $settings['reset_evergreen']){
			...
			$this->add_render_attribute('countdown', 'data-expire-action',
				$settings['expire_actions']);
				...
				<?php for ($i = 0; $i < $length; $i ++){ ?>
                    <div class="uael-countdown-<?php echo $labels[$i]; ?> uael-item">
							<span id="<?php echo $labels[$i]; ?>-wrapper-<?php echo $id; ?>"<?php echo $this->get_render_attribute_string('digits'); ?> >
								<?php if (TRUE === $edit_mode){ ?><?php echo __('00',
									'uael'); ?><?php } ?>
							</span>
