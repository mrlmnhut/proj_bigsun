...
class Dual_Heading extends Common_Widget{
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started video » %2$s', 'uael'),
						'<a href="https://www.youtube.com/watch?v=WmrSMl5g3ac&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc&index=16" target="_blank" rel="noopener">',
						'</a>'),
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/dual-color-heading-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function render(){
		...
		?>
        <div class="uael-module-content uael-dual-color-heading">            <<?php echo $settings['dual_tag_selection']; ?>>
	...
	<?php } ?><?php
		...
		?>
        <span class="uael-before-heading"><span class="elementor-inline-editing uael-dual-heading-text uael-first-text" data-elementor-setting-key="before_heading_text" data-elementor-inline-editing-toolbar="basic"><?php echo $this->get_settings_for_display('before_heading_text'); ?></span></span>
        <span class="uael-adv-heading-stack">
        <span class="elementor-inline-editing uael-dual-heading-text uael-highlight-text" data-elementor-setting-key="second_heading_text" data-elementor-inline-editing-toolbar="basic"><?php echo $this->get_settings_for_display('second_heading_text'); ?></span>
        </span><?php if (!empty($settings['after_heading_text'])){ ?>
            <span class="uael-after-heading">
            <span class="elementor-inline-editing uael-dual-heading-text uael-third-text" data-elementor-setting-key="after_heading_text" data-elementor-inline-editing-toolbar="basic"><?php echo $this->get_settings_for_display('after_heading_text'); ?></span>
            </span><?php } ?><?php // @codingStandardsIgnoreEnd ?><?php if (!empty($settings['heading_link']['url'])) { ?>
        </a>
	<?php } ?>
        </<?php echo $settings['dual_tag_selection']; ?>>        </div>
		<?php
		$html = ob_get_clean();
		echo $html;
	}
	...
	protected function _content_template(){
        ...
        <div class="uael-module-content uael-dual-color-heading">
            ...
            <# } #>
        </{{ settings.dual_tag_selection }}>        </div>
		<?php
	}
}
