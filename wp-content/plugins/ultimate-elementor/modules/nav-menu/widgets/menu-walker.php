...
class Menu_Walker extends \Walker_Nav_Menu{
	...
	public function start_el(&$output, $item, $depth = 0, $args = [], $id = 0){
		...
		if (isset($item->target) && '_blank' === $item->target && isset($item->xfn) && FALSE === strpos($item->xfn,
				'noopener')){
			$rel_xfn = ' noopener';
		}
	...
	function display_element(
		...
		return parent::display_element($element, $children_elements, $max_depth, $depth, $args,
			$output);
	}
}
