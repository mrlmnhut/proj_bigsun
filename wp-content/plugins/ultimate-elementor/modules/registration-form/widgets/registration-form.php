...
class RegistrationForm extends Common_Widget{
	...
	public static function get_user_roles(){
		...
		$roles      = isset($wp_roles->roles) ? $wp_roles->roles : [];
		$user_roles = [];
		...
		if ((!isset($integration_options['recaptcha_v3_key']) || '' === $integration_options['recaptcha_v3_key']) && (!isset($integration_options['recaptcha_v3_secretkey']) || '' === $integration_options['recaptcha_v3_secretkey'])){
			$repeater->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Please configure reCAPTCHA v3 setup from <a href="%s" target="_blank" rel="noopener">here</a>.',
						'uael'), $admin_link),
	...
	protected function register_settings_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description'  => __('Enable this option if you wish to hide the form at the frontend from logged in users.',
					'uael'),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Enter the message to display at the frontend for Logged in users.',
					'uael'),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __('The default option will assign the user role as per the WordPress backend setting.',
					'uael'),
				'content_classes' => 'uael-editor-doc',
				'condition'       => [
					'select_role' => 'default',
		...
		$this->add_control(
			...
			[
				...
				'description'  => __('Add the “Lost Password” link below the register button',
					'uael'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __('Yes', 'uael'),
				'label_off'    => __('No', 'uael'),
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Choose from above actions to perform after successful user registration. Click %1$s here %2$s to learn more.',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-elementor/#choose-post-registration-action" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function register_email_controls(){
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('Send the new user an email about their account. Click %1$s here %2$s to learn more.',
						'uael'),
						'<a href="https://uaelementor.com/docs/introducing-user-registration-form-widget/#send-email" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __('<b>Important Notice:</b> If you have only an Email field in the form, then please select the Custom option in the Email Template field above.',
					'uael'),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
				'condition'       => [
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __('<b>Note:</b> If you wish to send System Generated Password in the email content, use shortcode - <b>[field=password]</b>',
					'uael'),
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('For other form fields shortcode click %1$s here %2$s.',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-only-email-field/#how-to-customize-user-email-in-the-user-registration-form-widget-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function register_validation_message_controls(){
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => __('Error: Something went wrong! Unable to complete the registration process.',
					'uael'),
				'dynamic'     => [
					'active' => TRUE,
				],
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/introducing-user-registration-form-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Create a User Registration Form using Elementor » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-elementor/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Registration Form with Only Email Field » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-only-email-field/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Customize User Email » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-only-email-field/#how-to-customize-user-email-in-the-user-registration-form-widget-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s After Registration Actions » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-elementor/#choose-post-registration-action" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Google reCAPTCHA v3 support » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/user-registration-form-with-recaptcha/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Honeypot Spam Prevention field support » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/user-registration-form-with-honeypot/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s How to create a User Registration Form for a WooCommerce Page? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/create-user-registration-form-using-elementor/#example:-user-registration-form-on-a-woocommerce-page" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s How to manage Users on WordPress after Registration? » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/frequently-asked-questions-about-user-registration-forms/#3.-how-do-i-manage-users-on-wordpress-after-registration-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Frequently asked questions » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/frequently-asked-questions-about-user-registration-forms/" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
		...
		if ('true' === $settings['hide_form'] && is_user_logged_in() && !$is_editor){
			...
			if (!empty($settings['fields_list'])) :
				...
				if (!empty($settings['button_width_tablet'])){
					$this->add_render_attribute('submit-group', 'class',
						'elementor-md-' . $settings['button_width_tablet']);
				}
						...
						foreach ($settings['actions_array'] as $action){
							if ('send_email' === $action){
								...
								if (!empty($settings['redirect_url']['url'])){
									$this->add_render_attribute('widget-wrap', 'data-redirect-url',
				...
				$notify_mail = apply_filters('uael_registration_notify_email', $notify_mail,
					$settings);
                ...
                <div class="uael-registration-form" <?php echo $this->get_render_attribute_string('widget-wrap'); ?>>
                    <form class="elementor-form" method="post" <?php echo $this->get_render_attribute_string('form'); ?>>
                        <div <?php echo $this->get_render_attribute_string('wrapper'); ?>>
							...
							foreach ($settings['fields_list'] as $item_index => $item) :
								...
								$this->add_render_attribute('input' . $item_index, 'type',
									$field_input_type);
								...
								if (!$settings['show_labels']){
									$this->add_render_attribute('label' . $item_index, 'class',
								...
								if (!empty($item['required']) || 'email' === $field_type || 'password' === $field_type){
									...
									$this->add_render_attribute('input' . $item_index, 'required',
										'required');
								...
								if ('recaptcha_v3' === $field_type){
									$this->add_render_attribute('field-group' . $item_index,
										'class',
										'uael-recaptcha-align-' . $item['recaptcha_badge']);
								}

								if (!empty($item['width_tablet'])){
									$this->add_render_attribute('field-group' . $item_index,
										'class', 'elementor-md-' . $item['width_tablet']);
								}

								if (!empty($item['width_mobile'])){
									$this->add_render_attribute('field-group' . $item_index,
										'class', 'elementor-sm-' . $item['width_mobile']);
								}
                                    ...
                                    <div <?php echo $this->get_render_attribute_string('field-group' . $item_index); ?>>
										...
										switch ($field_type) :
											...
											case 'recaptcha_v3':
												if ('' !== $sitekey && '' !== $secretkey){
													...
													echo __('To use reCAPTCHA v3, you need to add the API Key and complete the setup process in Dashboard > Settings > UAE > User Registration Form Settings > reCAPTCHA v3.',
														'uael');
													echo '</div>';
												}
												break;
										...
										<?php if ('password' === $field_type) : ?>
                                            <div class="uael-pass-wrapper" style="display: none;">
                                                <div class="uael-pass-bar">
                                                    <div class="uael-pass-bar-color"></div>
                                                </div>
											...
											<?php if (!empty($settings['button_icon']) && '' !== $settings['button_icon']['value']) : ?>
                                                <span <?php echo $this->get_render_attribute_string('icon-align'); ?>>
													...
													<?php if (empty($settings['button_text'])) : ?>
                                                        <span class="elementor-screen-only"><?php _e('Submit',
																'uael'); ?></span>
													<?php endif; ?>
												</span>
											<?php endif; ?>
                            ...
                            <div class="uael-rform-footer elementor-field-group">
								...
								if ('true' === $settings['login'] && '' !== $settings['login_text']){
									...
									$this->add_render_attribute('login', 'class',
										'uael-rform-footer-link');

									if ('custom' === $settings['login_select'] && !empty($settings['login_url'])){

										$this->add_render_attribute('login', 'href',
											$settings['login_url']['url']);

										if ($settings['login_url']['is_external']){
											$this->add_render_attribute('login', 'target',
												'_blank');
										}
					...
					<?php
					$this->add_render_attribute('validation_messages', 'class',
					...
					if ('yes' === $settings['preview_message'] && $is_editor){
						if ('default' === $settings['message_wrap_style']){
							?>
                            <div class="uael-reg-preview-message elementor-alert success"><?php echo __('This is a success message preview!',
									'uael'); ?></div>
                            <div class="uael-reg-preview-message elementor-alert error"><?php echo __('This is a error message preview!',
									'uael'); ?></div>
						<?php }else{ ?>
                            <div class="uael-reg-preview-message success"><?php echo __('This is a success message preview!',
									'uael'); ?></div>
                            <div class="uael-reg-preview-message error"><?php echo __('This is a error message preview!',
									'uael'); ?></div>
						<?php } ?><?php } ?>
					...
					if ($is_allowed_register){
						...
						if ('' !== $error_string){
                            ...
                            <span class='uael-register-error-message'>
									...
									echo sprintf(__('Error! It seems like you have added <b>%s</b> field in the form more than once.',
										'uael'), $error_string);
									echo '</div>';
									?>
								</span>
						...
						if (isset($is_email_exists) && 0 === $is_email_exists){
                            ...
                            <span class='uael-register-error-message'>
									<?php
									echo '<div class="elementor-alert elementor-alert-warning">';
									echo __('For Registration Form E-mail field is required!',
										'uael');
									echo '</div>';
									?>
								</span>
                            ...
                            <span class='uael-register-error-message'>
									<?php
									echo '<div class="elementor-alert elementor-alert-warning">';
									echo __('Password field should be added to the form to use the Confirm Password field.',
										'uael');
									echo '</div>';
									?>
								</span>
                        ...
                        <span class='uael-register-error-message'>
								<?php
								echo '<div class="elementor-alert elementor-alert-warning">';
								echo __('To use the Registration Form on your site, you must set the "Allow new registrations" to "User accounts may be registered" setting from Network Admin -> Dashboard -> Settings.',
									'uael');
								echo '</div>';
								?>
							</span>
                        ...
                        <span class='uael-register-error-message'>
								<?php
								echo '<div class="elementor-alert elementor-alert-warning">';
								echo __('To use the Registration Form on your site, you must enable the "Anyone Can Register" setting from Dashboard -> Settings -> General -> Membership.',
									'uael');
								echo '</div>';
								?>
							</span>
