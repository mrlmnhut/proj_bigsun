...
class ErrorHandler{
	 ...
	 * @param int|false $exceptionLevel a LogLevel::* constant, or false to disable exception
	 *     handling
	 * @param int|false $fatalLevel a LogLevel::* constant, or false to disable fatal error
	 *     handling
	 *
	 * @return ErrorHandler
	 */
	...
	public function handleException($e){
		$this->logger->log(
			...
			sprintf('Uncaught Exception %s: "%s" at %s line %s', Utils::getClass($e),
	...
	public function handleError($code, $message, $file = '', $line = 0, $context = []){
		...
		if ($this->previousErrorHandler === TRUE){
			...
			return call_user_func($this->previousErrorHandler, $code, $message, $file, $line,
				$context);
		}
	}
