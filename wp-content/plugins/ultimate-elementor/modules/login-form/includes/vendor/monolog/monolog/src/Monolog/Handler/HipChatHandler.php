...
class HipChatHandler extends SocketHandler{
	 ...
	 * @param string $format The format of the messages (default to text, can be set to html if you
	 *     have html in the messages)
	...
	public function __construct(
		...
		if ($version == self::API_V1 && !$this->validateStringLength($name,
	...
	private function combineRecords($records){
		...
		foreach ($records as $record){
			...
			if (!$this->validateStringLength($batchRecord['formatted'],
