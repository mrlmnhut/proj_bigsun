...
class DES extends Base{
	 ...
	 * Sets the key.
	 *
	 * Keys can be of any length.  DES, itself, uses 64-bit keys (eg. strlen($key) == 8), however,
	 * we only use the first eight, if $key has more then eight characters in it, and pad $key with
	 * the null byte if it is less then eight characters long.
	 *
