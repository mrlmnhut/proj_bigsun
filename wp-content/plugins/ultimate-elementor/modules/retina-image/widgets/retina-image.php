			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/introducing-retina-image-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
        ...
        <div <?php echo $this->get_render_attribute_string('wrapper'); ?>>
            ...
            <figure class="wp-caption">
                ...
                <a <?php echo $this->get_render_attribute_string('link'); ?>>
					...
					$image_data = wp_get_attachment_image_src($settings['retina_image']['id'],
						$image_size, TRUE);

					$retina_data = wp_get_attachment_image_src($settings['real_retina']['id'],
						$image_size, TRUE);
