...
class Video extends Common_Widget{
	...
	protected function register_video_content(){
		...
		$default_youtube = apply_filters('uael_video_default_youtube_link',
			'https://www.youtube.com/watch?v=HJRzUQMhJMQ');

		$default_vimeo = apply_filters('uael_video_default_vimeo_link',
			'https://vimeo.com/274860274');
		...
		$this->add_control(
			...
			[
				...
				'raw'             => sprintf(__('<b>Note:</b> Make sure you add the actual URL of the video and not the share URL.</br></br><b>Valid:</b>&nbsp;https://www.youtube.com/watch?v=HJRzUQMhJMQ</br><b>Invalid:</b>&nbsp;https://youtu.be/HJRzUQMhJMQ',
					'uael')),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				/* translators: %1$s doc link */
				'raw'             => sprintf(__('<b>Note:</b> Make sure you add the actual URL of the video and not the categorized URL.</br></br><b>Valid:</b>&nbsp;https://vimeo.com/274860274</br><b>Invalid:</b>&nbsp;https://vimeo.com/channels/staffpicks/274860274',
					'uael')),
				'content_classes' => 'uael-editor-doc',
				'condition'       => [
					'video_type' => 'vimeo',
		...
		if (parent::is_internal_links()){
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('Go to your Wistia video, right click, "Copy Link & Thumbnail" and paste here. %1$s Learn more %2$s.',
						'uael'),
						'<a href="https://uaelementor.com/docs/video-widget/#how-to-get-a-valid-link-for-wistia-video-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => __('Go to your Wistia video, right click, "Copy Link & Thumbnail" and paste here.',
						'uael'),
					'content_classes' => 'uael-editor-doc',
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'description' => __('This option lets you use a YouTube player that does not show a YouTube logo.',
					'uael'),
				'type'        => Controls_Manager::SWITCHER,
				'condition'   => [
					'video_type'  => 'youtube',
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf(__('Enable this option if you are not able to see custom thumbnail or overlay color on Mobile. Please read %1$s this article %2$s for more information.',
						'uael'),
						'<a href="https://uaelementor.com/docs/double-click-on-mobile-for-video/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
	...
	protected function register_video_lightbox(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'description'        => __('Note: Entrance animation will work only at the frontend.',
					'uael'),
	...
	protected function register_video_sticky(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'description'        => __('Note: This is spacing around the sticky video with respect to the Alignment chosen.',
					'uael'),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => ['px'],
				'selectors'          => [
		...
		$this->add_control(
			...
			[
				'label'       => __('Enable', 'uael'),
				'description' => __('Enable this option to display the informative text under Sticky video.',
					'uael'),
				'type'        => Controls_Manager::SWITCHER,
				'label_off'   => __('No', 'uael'),
				'label_on'    => __('Yes', 'uael'),
	...
	protected function register_video_subscribe_bar(){
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf(__('Click %1$s here %2$s to find your YouTube Channel Name.',
						'uael'),
						'<a href="https://uaelementor.com/docs/youtube-channel-name-and-channel-id/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'video_type'           => 'youtube',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf(__('Click %1$s here %2$s to find your YouTube Channel ID.',
						'uael'),
						'<a href="https://uaelementor.com/docs/youtube-channel-name-and-channel-id/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
		...
		$this->add_control(
			...
			[
				...
				'description'  => __('Choose a breakpoint where the subscribe bar content will stack.',
					'uael'),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'none',
				'options'      => [
		...
		if (parent::is_internal_links()){
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started article » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/video-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf(__('%1$s Getting started video » %2$s', 'uael'),
						'<a href="https://www.youtube.com/watch?v=2RlvBU_EFV4&index=18&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Unable to edit Video widget » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/unable-to-edit-video-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Display YouTube Subscribe Bar for Video. » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/youtube-subscribe-bar-for-video/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Find YouTube Channel Name and Channel ID. » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/youtube-channel-name-and-channel-id/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Enable Sticky Video » %2$s', 'uael'),
						'<a href="https://uaelementor.com/docs/sticky-video/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf(__('%1$s Get Wistia Link and Thumbnail text » %2$s',
						'uael'),
						'<a href="https://uaelementor.com/docs/video-widget/#how-to-get-a-valid-link-for-wistia-video-" target="_blank" rel="noopener">',
						'</a>'),
					'content_classes' => 'uael-editor-doc',
	...
	protected function get_video_thumb($id){
		...
		if ('yes' === $settings['show_image_overlay']){
			...
			$thumb = Group_Control_Image_Size::get_attachment_image_src($settings['image_overlay']['id'],
				'image_overlay', $settings);

		}else{

			if ('youtube' === $settings['video_type']){

				$thumb = 'https://i.ytimg.com/vi/' . $id . '/' . apply_filters('uael_video_youtube_image_quality',
						$settings['yt_thumbnail_size']) . '.jpg';
				...
				$thumb = 'https://embedwistia-a.akamaihd.net/deliveries/' . $this->getStringBetween($url,
						'deliveries/', '?');
			}
		}
                    ...
                    <div class="uael-vimeo-headers">
						...
						<?php if ('yes' === $settings['vimeo_byline']){ ?>
                            <div class="uael-vimeo-byline">
								<?php _e('from ', 'uael'); ?>
                                <a href="<?php $settings['vimeo_link']; ?>"><?php echo $vimeo[0]['user_name']; ?></a>
                            </div>
						<?php } ?>
                    </div>
				<?php } ?>
	...
	protected function get_video_embed(){
		...
		if ('yes' === $settings['video_double_click']){
			...
			$device = (FALSE !== (stripos($_SERVER['HTTP_USER_AGENT'],
				'iPhone')) ? 'true' : 'false');
		}
			...
			if (UAEL_Helper::is_elementor_updated()){
				...
				if ((isset($settings['play_icon']) || isset($settings['new_play_icon']))){
					...
					if ($play_icon_is_new || $play_icon_migrated){
						ob_start();
						\Elementor\Icons_Manager::render_icon($settings['new_play_icon'],
							['aria-hidden' => 'true']);
						$html = ob_get_clean();
		...
		if ('img' === $settings['play_source']){
			$this->add_render_attribute('video-play', 'class',
				'uael-animation-' . $settings['hover_animation_img']);
		}elseif ('default' === $settings['play_source']){
			$this->add_render_attribute('video-play', 'class',
				'uael-animation-' . $settings['default_hover_animation']);
		}else{
			$this->add_render_attribute('video-play', 'class',
				'uael-animation-' . $settings['hover_animation']);
		}
