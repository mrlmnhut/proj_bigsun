            ...
            <div id="poststuff">
                <div id="post-body" class="columns-1">
                    <div id="post-body-content">
                        <div class="uael-integration-form-wrap">
                                ...
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label for="uael-integration-google-api-key" class="uael-integration-heading"><?php _e('Google Map API Key',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong>
												<?php
												...
												/* translators: %1$s: a tag open. */
													__('This setting is required if you wish to use Google Map in your website. Need help to get Google map API key? Read %1$s this article %2$s.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
                            ...
                            <div class="widgets postbox">
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label for="uael-integration-google-language" class="uael-integration-heading"><?php _e('Google Map Localization Language',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong> <?php _e('This setting sets localization language to google map. The language affects the names of controls, copyright notices, driving directions, and control labels.',
													'uael'); ?></p>
                                            <p class="uael-p">
												<?php
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('Need help to understand this feature? Read %1$s this article %2$s.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
                                            ...
                                            <select name="uael_integration[language]" id="uael-integration-google-language" class="placeholder placeholder-active">
                                                <option value=""><?php _e('Default',
														'uael'); ?></option>
												<?php foreach ($languages as $key => $value){ ?><?php
													$selected = '';
                            ...
                            <div class="widgets postbox">
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label for="uael-integration-google-places-key" class="uael-integration-heading"><?php _e('Business Reviews - Google Places API Key',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong>
												<?php
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('This setting is required if you wish to use Google Places Reviews in your website. Need help to get Google Places API key? Read %1$s this article %2$s.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
											...
											<?php if ('yes' === $google_status && $is_saved){ ?>
                                                <span class="uael-response-success"><?php _e('Your API key authenticated successfully!',
														'uael'); ?></span>
											<?php }elseif ('no' === $google_status){ ?>
                                                <span class="uael-response-warning"><?php _e('Entered API key is invalid',
														'uael'); ?></span>
											<?php }elseif ('exceeded' === $google_status && $is_saved){ ?>
                                                <span class="uael-google-error-response">
														<span class="uael-response-warning"><?php _e('<b>Google Error Message:</b>',
																'uael'); ?></span>
														<?php
														printf(
														/* translators: %1$s command. */
															__('You have exceeded your daily request quota for this API. If you did not set a custom daily request quota, verify your project has an active billing account.</br>Click %1$s here %2$s to enable billing.',
																'uael'),
                            ...
                            <div class="widgets postbox">
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label for="uael-integration-yelp-api-key" class="uael-integration-heading"><?php _e('Business Reviews - Yelp API Key',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong>
												<?php
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('This setting is required if you wish to use Yelp Reviews in your website. Need help to get Yelp API key? Read %1$s this article %2$s.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
											...
											<?php if ('yes' === $yelp_status && $is_saved){ ?>
                                                <div class="uael-response-success"><?php _e('Your API key authenticated successfully!',
														'uael'); ?></div>
											<?php }elseif ('no' === $yelp_status){ ?>
                                                <div class="uael-response-warning"><?php _e('Entered API key is invalid',
														'uael'); ?></div>
											<?php } ?>
                            ...
                            <div class="widgets postbox">
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label class="uael-integration-heading"><?php _e('Setup reCAPTCHA v3',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong>
												<?php
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('%1$s reCAPTCHA v3 %2$s is a free service by Google that protects your website from spam and abuse. It does this while letting your valid users pass through with ease.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
                                            ...
                                            <p class="install-help uael-p">
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('Read %1$s this article %2$s to learn more.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
                                            ...
                                            <label for="uael-recaptcha-v3-key" class="uael-integration-heading"><?php _e('Site key',
													'uael'); ?></label>
                                            ...
                                            <br/>
                                            <br/>
                                            <label for="uael-recaptcha-v3-secretkey" class="uael-integration-heading"><?php _e('Secret key',
													'uael'); ?></label>
                                            ...
                                            <br/>
                                            <br/>
                                            <label for="uael-recaptcha-v3-score" class="uael-integration-heading"><?php _e('Score Threshold',
													'uael'); ?></label>
											...
											<?php
											echo __('Score threshold should be a value between 0 and 1, default: 0.5',
												'uael');
											?>
                                        </div>
                                    </div>
                            ...
                            <div class="widgets postbox">
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label class="uael-integration-heading"><?php _e('Login Form - Google Client ID',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong>
												<?php
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('This setting is required if you wish to use Login with Google in your website. Need help to get Google Client ID? Read %1$s this article %2$s.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
                                            ...
                                            <label for="uael-google-client-id" class="uael-integration-heading"><?php _e('Google Client ID',
													'uael'); ?></label>
                            ...
                            <div class="widgets postbox">
                                <div class="inside">
                                    <div class="form-wrap">
                                        <div class="form-field">
                                            <label class="uael-integration-heading"><?php _e('Login Form - Facebook App Details',
													'uael'); ?></label>
                                            <p class="install-help uael-p"><strong><?php _e('Note:',
														'uael'); ?></strong>
												<?php
												...
												printf(
												/* translators: %1$s: a tag open. */
													__('This setting is required if you wish to use Login with Facebook in your website. Need help to get Facebook App Details? Read %1$s this article %2$s.',
														'uael'),
													$a_tag_open,
													$a_tag_close
												);
                                            ...
                                            <label for="uael-facebook-app-id" class="uael-integration-heading"><?php _e('Facebook App ID',
													'uael'); ?></label>
                                            ...
                                            <br/>
                                            <br/>
                                            <label for="uael-facebook-secret-key" class="uael-integration-heading"><?php _e('Facebook App Secret',
													'uael'); ?></label>
						...
						<?php submit_button(__('Save Changes', 'uael'),
							'uael-save-integration-options button-primary button button-hero'); ?>
