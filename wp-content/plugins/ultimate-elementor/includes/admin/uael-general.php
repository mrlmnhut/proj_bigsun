            ...
            <div id="post-body-content">
                ...
                <div class="widgets postbox">
                    <h2 class="hndle uael-flex uael-widgets-heading">
                        <span><?php esc_html_e('Widgets', 'uael'); ?></span>
                        <div class="uael-bulk-actions-wrap">
                            <a class="bulk-action uael-activate-all button"> <?php esc_html_e('Activate All',
									'uael'); ?> </a>
                            <a class="bulk-action uael-deactivate-all button"> <?php esc_html_e('Deactivate All',
									'uael'); ?> </a>
                        </div>
                    </h2>
                    ...
                    <div id="side-sortables">
						<?php if ($enable_kb){ ?>
                            <div class="postbox">
                                ...
                                <div class="inside">
                                    <p>
										<?php esc_html_e('Not sure how something works? Take a peek at the knowledge base and learn.',
											'uael'); ?>
                                    </p>
                                    <a href='<?php echo esc_url($kb_url); ?> ' target="_blank" rel="noopener"><?php esc_attr_e('Visit Knowledge Base »',
											'uael'); ?></a>
                                </div>
                            </div>
						<?php } ?>
                                ...
                                <div class="inside">
                                    <p>
										...
										/* translators: %1$s: uael name. */
											esc_html__('Got a question? Get in touch with %1$s developers. We\'re happy to help!',
												'uael'),
											UAEL_PLUGIN_NAME
										);
										?>
									...
									<?php
									$uael_support_link      = apply_filters('uael_support_link',
										$support_url);
									$uael_support_link_text = apply_filters('uael_support_link_text',
										__('Submit a Ticket »', 'uael'));
						...
						<?php if ($enable_beta){ ?>
                            <div class="postbox">
                                ...
                                <div class="inside">
                                    <p>
										<?php
										esc_html_e('Enable this option to receive update notifications for beta versions.',
											'uael');
										?>
                                    </p>
                                    <p class="admin-help uael-p">
										...
										/* translators: %1$s: a tag open. */
											__('Please read %1$s this article %2$s to know more.',
												'uael'),
											$a_tag_open,
											$a_tag_close
										);
