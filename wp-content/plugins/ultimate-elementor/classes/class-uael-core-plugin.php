...
class UAEL_Core_Plugin{
	...
	private function setup_actions_filters(){
		...
		add_shortcode('uael-template', [$this, 'uael_template_shortcode']);
	...
	function register_widget_scripts(){
		...
		wp_register_script('uael-google-maps-cluster',
			'https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js',
			['jquery'], UAEL_VER, TRUE);

		wp_register_script('uael-video-subscribe', 'https://apis.google.com/js/platform.js',
			['jquery'], UAEL_VER, TRUE);

		wp_register_script('uael-google-login', 'https://apis.google.com/js/api:client.js',
			['jquery'], UAEL_VER, TRUE);

		wp_register_script('uael-google-recaptcha',
			'https://www.google.com/recaptcha/api.js?onload=onLoadUAEReCaptcha&render=explicit',
			['jquery', 'uael-registration'], UAEL_VER, TRUE);

		foreach ($js_files as $handle => $data){

			wp_register_script($handle, UAEL_URL . $data['path'], $data['dep'], UAEL_VER,
				$data['in_footer']);
		}
