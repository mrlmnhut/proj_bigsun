...
// non transition, just trigger callback
     ...
     *   @param {Boolean} isCleaning - removes transition styles after
     *     transition
...
// -------------------------- isotopeDefinition -------------------------- //
    ...
    proto._sort = function () {
        ...
        if (!this._getIsSameSortBy(sortBys)) {
            // concat all sortBy and sortHistory, add to front, oldest goes in
            // last
    ...
    function getItemSorter(sortBys, sortAsc) {
        return function sorter(itemA, itemB) {
            ...
            for (var i = 0; i < sortBys.length; i++) {
                ...
                if (a > b || a < b) {
                    // if sortAsc is an object, use the value given the sortBy
                    // key
