...
function bsf_systeminfo(){
    ...
    <table class="wp-list-table widefat fixed bsf-sys-info">
		...
		$usage = function_exists('memory_get_usage') ? round(memory_get_usage() / 1024 / 1024,
			2) : 0;
		?>
        <tr>
            <td>Memory Usage</td>
        ...
        <tr class="<?php echo (!function_exists('curl_version')) ? 'bsf-alert' : ''; ?>">
            ...
            <td>
				...
				if (function_exists('curl_version')){
                    ...
                    <div>SSL Version : <strong><?php echo $curl_info['ssl_version']; ?></strong>
                    </div>
    ...
    <table class="wp-list-table widefat fixed bsf-sys-info">
        ...
        <tr>
            <td>Author</td>
            <td>
                <a href="<?php echo $theme_data->ThemeURI; ?>"><?php echo $theme_data->Author; ?></a>
            </td>
        </tr>
        </tbody>
    </table>
