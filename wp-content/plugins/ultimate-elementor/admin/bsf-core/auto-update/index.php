...
<div class="wrap bsf-sp-screen">
	...
	?>
    <a href="<?php echo (is_multisite()) ? network_admin_url($url) : admin_url($url); ?>"><?php echo __('Manage ' . $txt . ' here',
		'bsf'); ?></a> |
    <a href="<?php echo $reg_url; ?>"><?php echo __('Back to Registration',
		'bsf'); ?></a>
	<?php endif; ?>
</div>        <?php
...
<div class="wrap bsf-sp-screen">
    ...
    <div class="bsf-pr-header">
        ...
        <div class="bsf-pr-decription"><?php echo __('Please register using the form below and get instant access to our support portal, updates, extensions and more!',
			'bsf'); ?></div>
    </div>
    <div class="bsf-user-registration-form-wrapper">
        <div class="bsf-user-registration-inner-wrapper">
            <div class="bsf-ur-wrap">
                <div class="bsf-reg-form-wrap">
                    <form action="" method="post" id="bsf-user-form" class="bsf-pr-form">
                        ...
                        <div class="bsf-pr-form-row">
                            <input type="text" id="bsf_username" name="bsf_username" value="" spellcheck="false" placeholder="<?php echo __('Your Name',
								'bsf'); ?>" class="bsf-pr-input stored" data-required="true"/>
                        </div>
                        <div class="bsf-pr-form-row">
                            <input type="text" id="bsf_useremail" name="bsf_useremail" value="" spellcheck="false" placeholder="<?php echo __('Your Email Address',
								'bsf'); ?>" class="bsf-pr-input stored" data-required="true"/>
                        </div>
                        <div class="bsf-pr-form-row">
                            <input type="text" id="bsf_useremail_reenter" name="bsf_useremail_reenter" value="" spellcheck="false" placeholder="<?php echo __('Verify Email Address',
								'bsf'); ?>" class="bsf-pr-input stored" data-required="true"/>
                        </div>
                        <div class="bsf-pr-form-row">
                            <input type="checkbox" name="ultimate_user_receive" id="checkbox-subscribe" value="true" checked="checked" data-required="false"/>
                            <label class="checkbox-subscribe" for="checkbox-subscribe"><?php echo __('Receive important news, updates & freebies on email.',
								'bsf'); ?></label>
                        </div>

                    </form>
                    <div class="bsf-pr-submit-row">
                        <input type="button" class="bsf-pr-form-submit button-primary bsf-button-primary" data-form-id="bsf-user-form" value="<?php echo __('Register and Proceed',
							'bsf'); ?>"/>
                ...
                <div class="bsf-pr-form-row bsf-privacy-stat"><?php echo __('We respect your privacy & of course you can unsubscribe at any time.',
					'bsf'); ?></div>
            </div>
        </div>
    </div>
	...
	?>
	<?php
	$brainstrom_bundled_products = (get_option('brainstrom_bundled_products')) ? get_option('brainstrom_bundled_products') : [];
    ...
    <div class="bsf-pr-header bsf-left-header">
        ...
        <div class="bsf-pr-decription"><?php echo __('Validate your purchase keys and get eligible for receiving one click updates, extensions and freebies.',
			'bsf'); ?></div>
    </div>
    ...
    <div class="inside">
        ...
        <h2 class="nav-tab-wrapper">
            ...
            <a href="#bsf-licenses" class="nav-tab <?php echo ($tab !== 'author') ? 'nav-tab-active' : ''; ?>"><?php echo __('Licenses',
				'bsf'); ?></a>
			<?php endif ?>
			...
			<?php if ($author) : ?>
            <a href="#bsf-author" class="nav-tab <?php echo ($tab === 'author') ? 'nav-tab-active' : ''; ?>"><?php echo __('Debug',
				'bsf'); ?></a>
			<?php endif; ?>
        ...
        <div id="bsf-licenses" class="bsf-tab <?php echo ($tab !== 'author') ? 'bsf-tab-active' : ''; ?>">
            <div class="inner">
                <table class="wp-list-table widefat fixed licenses">
					...
					$name = apply_filters("agency_updater_productname_{$id}",
						$plugin_data['Name']);
					...
					$remove_frm_registration = apply_filters('bsf_remove_' . $id . '_from_registration_listing',
						FALSE, $id);
                    ...
                    <tr id="<?php echo $row_id; ?>" class="<?php echo $alternate . ' ' . $status; ?>">
                        ...
                        <td>
                            ...
                            Purchase Verified
							<?php else : ?>
                            <input type="text" class="bsf-form-input" name="purchase_key" spellcheck="false" data-required="true" value="<?php echo $purchase_key; ?>" <?php echo $readonly; ?>/>
							<?php endif ?>
                        </td>
                        <td>
                            ...
                            <a href="<?php echo $purchase_url; ?>" target="_blank" class="bsf-purchase-link" data-row-id="<?php echo $row_id; ?>"/>Buy License</a>
                            <span class="spinner bsf-spinner"></span>
							<?php else : ?>
                            <input type="button" class="button bsf-submit-button-deregister" value="De-register" data-row-id="<?php echo $row_id; ?>" <?php echo $common_data; ?>/>
                            <span class="spinner bsf-spinner"></span>
							<?php endif; ?>
                        </td>
                    </tr>
                ...
                <div class="bsf-row">
                    <div class="bsf-column">
                        <div class="bsf-column-inner">
                            ...
                            <span class="bsf-span"><?php echo __('Enable Developer access',
								'bsf'); ?>
								,<br/><?php echo __('Read more about developer access ',
									'bsf'); ?><a href="<?php echo bsf_get_api_site() . 'license-registration-faqs/#developer-access'; ?>" target="_blank"><?php echo __('here',
									'bsf'); ?></a></span>
                    ...
                    <div class="bsf-column">
                        <div class="bsf-column-inner">
                            ...
                            <span class="bsf-span"><?php printf(__('Check if there are updates available of plugins by %s.',
								'bsf'), BSF_UPDATER_FULLNAME); ?></span>
							<?php
							$reset_url = add_query_arg('force-check-update', '');
							?>
                            <a class="button-primary bsf-cp-update-btn" href="<?php echo $reset_url; ?>"><?php echo __('Check Updates Now',
								'bsf'); ?></a>
                        </div>
                    </div>
                    <div class="bsf-column">
                        <div class="bsf-column-inner">
							...
							<?php
							$request_support = apply_filters('agency_updater_request_support',
								bsf_get_api_site() . 'request-support/');
							?>
                            <span class="bsf-span"><?php echo __('Having any trouble using our products? Head to our support center to get your issues resolved.',
								'bsf'); ?></span>
                            <a class="button-primary bsf-cp-support-btn" href="<?php echo $request_support; ?>" target="_blank"><?php echo __('Request Support',
								'bsf'); ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bsf-row">
                    <div class="bsf-column">
                        <div class="bsf-column-inner">
                            ...
                            <a class="button-primary" href="<?php echo $reset_url; ?>"><?php printf(__('Reset %s Registration',
								'bsf'), BSF_UPDATER_SHORTNAME); ?></a>
                        </div>
                    </div>
                    <div class="bsf-column">
                        <div class="bsf-column-inner">
                            ...
                            <a class="button-primary" href="<?php echo $url; ?>"><?php echo __('Check Bundled Products',
								'bsf'); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="bsf-column">
                        <div class="bsf-column-inner">
                            ...
                            <h2><?php printf(__('%s Menu in Settings?', 'bsf'),
								BSF_UPDATER_SHORTNAME); ?></h2>
                            <span class="bsf-span">
									<?php printf(__('Move the %s menu to WordPress settings?',
										'bsf'), BSF_UPDATER_SHORTNAME); ?>
									</span>
                            <a class="button-primary brainstorm_menu" href="#"><?php echo __('Update',
								'bsf'); ?></a>
                            <span class="spinner bsf-spinner"></span>
