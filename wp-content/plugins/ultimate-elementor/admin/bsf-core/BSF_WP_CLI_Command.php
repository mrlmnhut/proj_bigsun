...
class BSF_WP_CLI_Command extends WP_CLI_Command{
	 ...
	 *
	 * <priduct-id>
	 *      Product id is unique for each brainstorm product, it can be found in the file
	 * <product-root-directory>/admin/.bsf.yml
	 *
	 * <license-key>
	 *      Your purchase key.
	 *
	 ...
	 *      - This will activate the license for plugin Ultimate Addons for beaver builder with
	 * purchase key <purchase-key>
	 *  2. wp brainstormforce license deactivate uabb <purchase-key>
	 *      - This will deactivate the license for plugin Ultimate Addons for beaver builder with
	 * purchase key <purchase-key>
	 */
