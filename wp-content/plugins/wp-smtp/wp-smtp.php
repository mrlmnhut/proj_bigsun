...
class WP_SMTP{
	...
	public function hooks(){
		...
		register_deactivation_hook(__FILE__, [$this, 'wp_smtp_deactivate']);

		add_filter('plugin_action_links', [$this, 'wp_smtp_settings_link'], 10, 2);
		add_action('init', [$this, 'load_textdomain']);
		add_action('phpmailer_init', [$this, 'wp_smtp']);
		add_action('wp_mail_failed', [$this, 'catch_phpmailer_error']);
		add_action('admin_menu', [$this, 'wp_smtp_admin']);
	}
	...
	function wp_smtp_admin(){
		add_options_page('WP SMTP Options', 'WP SMTP', 'manage_options', __FILE__,
			[$this, 'wp_smtp_page']);
	}
