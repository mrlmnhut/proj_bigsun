        ...
        <td><?php if ( $has_paid_plan ) {
		        ...
		        if (!$is_whitelabeled){
			        if (is_object($license)){
				        ...
				        fs_require_template('account/partials/deactivate-license-button.php',
					        $view_params);
			        }else{
                        ...
                        <?php if ( ! $license->is_lifetime() && is_object( $subscription ) ) : ?>
                            ...
                            <tr <?php if ( 1 == $row_index % 2 ) {
                                ...
                                <?php
		                                ...
		                                $downgrade_x_confirm_text          = fs_text_inline('%1$s will immediately stop all future recurring payments and your %2$s plan license will expire in %3$s.',
			                                'downgrade-x-confirm', $slug);
