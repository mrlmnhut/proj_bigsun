...
$message_above_input_field = (!$has_last_license_user_id) ?
	fs_text_inline('Please enter the license key to enable the debug mode:',
		'submit-developer-license-key-message', $slug) :
	sprintf(
		fs_text_inline('To enter the debug mode, please enter the secret key of the license owner (UserID = %d), which you can find in your "My Profile" section of your User Dashboard:',
			'submit-addon-developer-key-message', $slug),
        ...
        $(document).ready(function () {
            ...
            function setDeveloperLicenseDebugMode(licenseOrUserKey) {
                ...
                $.ajax({
                    ...
                    error: function () {
                        showError( <?php echo json_encode(fs_text_inline('An unknown error has occurred.',
							'unknown-error', $slug)) ?> );
                        resetButtons();
                    }
                });
