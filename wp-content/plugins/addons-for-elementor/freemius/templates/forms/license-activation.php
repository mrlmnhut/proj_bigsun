...
$ownership_change_option_text = fs_text_inline("Associate with the license owner's account.",
	'associate-account-with-license-owner', $slug);
 ...
 * @since 2.3.2
 */
$is_user_change_supported = (!$fs->is_addon() || !$fs->get_parent_instance()
	...
	$( document ).ready(function() {
        ...
        var
            ...
            fetchLicenseUserData = function () {
                ...
                $activateLicenseButton.html('<?php fs_esc_js_echo_inline('Please wait',
					'please-wait', $slug) ?>...');
