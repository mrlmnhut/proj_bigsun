...
?></h3>
                    ...
                    <div class="lae-inner lae-box-inner">
                        <div class="lae-spacer" style="height: 15px"></div>
                        <label class="lae-label lae-label-outside"><?php
...
?></p>
                            <div class="lae-toggle">
                                <input type="checkbox" class="lae-checkbox" name="lae_enable_debug" id="lae_enable_debug" data-default="" value="<?php
echo  $debug_mode ;
?>" <?php 
...
?>
                            ...
                            <ul>
                                <li>
                                    <a href="https://livemeshelementor.com/posts-block/" title="Post Blocks Addon" target="_blank">Post
                                ...
                                <li>
                                    <a href="https://livemeshelementor.com/twitter-grid/" title="Twitter Grid Addon">Twitter Grid</a> to help showcase tweets on your site with load more option.
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://livemeshelementor.com/vimeo-grid/" title="Vimeo Grid Addon">Vimeo Grid</a> to help showcase showcase a collection of Vimeo videos obtained using Vimeo API given a User ID, Channel ID, Album ID or a Group ID. Load More option is provided.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/instagram-grid/" title="Instagram Grid Addon">Instagram Grid</a> to help display images and videos obtained from Instagram API given one or more user names or hash tags.
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://livemeshelementor.com/accordion/" title="Accordion/Toggle Addon" target="_blank">Accordion/Toggle</a> - Controls
                                    that capture collapsible content panels when space is limited.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/sliders/" title="Image Slider Widget" target="_blank">Image
                                ...
                                <li>
                                    <a href="https://livemeshelementor.com/image-gallery/" title="Image Gallery Widget" target="_blank">Image
                                        Gallery</a> - Create a gallery of images with options for masonry
                                    or fit rows, pagination, lazy load, lightbox support etc.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/video-gallery/" title="Video Gallery Widget" target="_blank">Video
                                        Gallery</a> - Create a beautiful gallery of videos to help
                                    showcase a collection of YouTube/Vimeo videos on your site.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/gallery-carousel/" title="Image Carousel" target="_blank">Image
                                        Carousel</a> - Build a responsive carousel of images.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/gallery-carousel/" title="Video Carousel" target="_blank">Video
                                        Carousel</a> - Build a responsive carousel of YouTube/Vimeo
                                    videos.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/buttons/" title="Buttons Addon" target="_blank">Buttons</a> - Animated buttons with great choice of colors.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/icon-lists/" title="Icon List" target="_blank">Icon List</a> - - Create a list of icons with description and
                                    link - for social media profiles,
                                    for showcasing services or features as well with icons or images.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/faq-element/" title="FAQ Addon" target="_blank">FAQ</a> - Create a set of Frequently Asked Questions for display
                                    in a
                                    page.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/features/" title="Features Addon" target="_blank">Features Addon</a> for showcasing product features or services
...
?>
                            ...
                            <ul>
                                <li>
                                    <a href="https://livemeshelementor.com/portfolio-grid-pro/" title="Posts Grid" target="_blank">Lazy Load</a> - The portfolio/post grid and image gallery
                                    elements
                                    incorporate option to lazy load posts/images with the click of a Load More button.
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/portfolio-grid-pro/" title="Posts Grid" target="_blank">Load on Scroll or Infinite Scroll</a> - The portfolio/post grid and image gallery
                                    elements
                                    incorporate option to lazy load posts/images automatically as the user scrolls down the page (infinite scroll).
                                </li>
                                <li>
                                    <a href="https://livemeshelementor.com/portfolio-grid-pro/" title="Posts Grid" target="_blank">Pagination</a> - Create a grid of posts or custom post types with
                                    AJAX
                                ...
                                <li>
                                    <strong>Multiple Skins/Styles</strong> - The premium version comes with support for about eight skins for posts/portfolio grid.
                                </li>
                                <li>
                                    <strong>Header Styles</strong> - About seven header styles with responsive dropdown support for filters on posts/portfolio grid.
                                </li>
                            ...
                            <ul>
                                <li>
                                    <strong>Dedicated Support Portal</strong> - The customers will be provided access to
                                    a
